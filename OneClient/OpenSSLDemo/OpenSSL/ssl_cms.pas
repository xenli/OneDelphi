...
begin
 if @CMS_sign = nil then
	 begin
		 @CMS_get0_type:= LoadFuncCLibCrypto('CMS_get0_type');
		 @CMS_dataInit:= LoadFuncCLibCrypto('CMS_dataInit');
		 @CMS_dataFinal:= LoadFuncCLibCrypto('CMS_dataFinal');
		 @CMS_get0_content:= LoadFuncCLibCrypto('CMS_get0_content');
		 @CMS_is_detached:= LoadFuncCLibCrypto('CMS_is_detached');
		 @CMS_set_detached:= LoadFuncCLibCrypto('CMS_set_detached');
		 @d2i_CMS_bio:= LoadFuncCLibCrypto('d2i_CMS_bio');
		 @i2d_CMS_bio:= LoadFuncCLibCrypto('i2d_CMS_bio');
		 @BIO_new_CMS:= LoadFuncCLibCrypto('BIO_new_CMS');
		 @i2d_CMS_bio_stream:= LoadFuncCLibCrypto('i2d_CMS_bio_stream');
		 @PEM_write_bio_CMS_stream:= LoadFuncCLibCrypto('PEM_write_bio_CMS_stream');
		 @SMIME_read_CMS:= LoadFuncCLibCrypto('SMIME_read_CMS');
		 @SMIME_write_CMS:= LoadFuncCLibCrypto('SMIME_write_CMS');
		 @CMS_final:= LoadFuncCLibCrypto('CMS_final');
		 @CMS_sign:= LoadFuncCLibCrypto('CMS_sign');
		 @CMS_sign_receipt:= LoadFuncCLibCrypto('CMS_sign_receipt');
		 @CMS_data:= LoadFuncCLibCrypto('CMS_data');
		 @CMS_data_create:= LoadFuncCLibCrypto('CMS_data_create');
		 @CMS_digest_verify:= LoadFuncCLibCrypto('CMS_digest_verify');
		 @CMS_digest_create:= LoadFuncCLibCrypto('CMS_digest_create');
		 @CMS_EncryptedData_decrypt:= LoadFuncCLibCrypto('CMS_EncryptedData_decrypt');
		 @CMS_EncryptedData_encrypt:= LoadFuncCLibCrypto('CMS_EncryptedData_encrypt');
		 @CMS_EncryptedData_set1_key:= LoadFuncCLibCrypto('CMS_EncryptedData_set1_key');
		 @CMS_verify:= LoadFuncCLibCrypto('CMS_verify');
		 @CMS_verify_receipt:= LoadFuncCLibCrypto('CMS_verify_receipt');
		 @CMS_get0_signers:= LoadFuncCLibCrypto('CMS_get0_signers');
		 @CMS_encrypt:= LoadFuncCLibCrypto('CMS_encrypt');
		 @CMS_decrypt:= LoadFuncCLibCrypto('CMS_decrypt');
		 @CMS_decrypt_set1_pkey:= LoadFuncCLibCrypto('CMS_decrypt_set1_pkey');
		 @CMS_decrypt_set1_key:= LoadFuncCLibCrypto('CMS_decrypt_set1_key');
		 @CMS_decrypt_set1_password:= LoadFuncCLibCrypto('CMS_decrypt_set1_password');
		 @CMS_get0_RecipientInfos:= LoadFuncCLibCrypto('CMS_get0_RecipientInfos');
		 @CMS_RecipientInfo_type:= LoadFuncCLibCrypto('CMS_RecipientInfo_type');
		 @CMS_EnvelopedData_create:= LoadFuncCLibCrypto('CMS_EnvelopedData_create');
		 @CMS_add1_recipient_cert:= LoadFuncCLibCrypto('CMS_add1_recipient_cert');
		 @CMS_RecipientInfo_set0_pkey:= LoadFuncCLibCrypto('CMS_RecipientInfo_set0_pkey');
		 @CMS_RecipientInfo_ktri_cert_cmp:= LoadFuncCLibCrypto('CMS_RecipientInfo_ktri_cert_cmp');
		 @CMS_RecipientInfo_ktri_get0_algs:= LoadFuncCLibCrypto('CMS_RecipientInfo_ktri_get0_algs');
		 @CMS_RecipientInfo_ktri_get0_signer_id:= LoadFuncCLibCrypto('CMS_RecipientInfo_ktri_get0_signer_id');
		 @CMS_add0_recipient_key:= LoadFuncCLibCrypto('CMS_add0_recipient_key');
		 @CMS_RecipientInfo_kekri_get0_id:= LoadFuncCLibCrypto('CMS_RecipientInfo_kekri_get0_id');
		 @CMS_RecipientInfo_set0_key:= LoadFuncCLibCrypto('CMS_RecipientInfo_set0_key');
		 @CMS_RecipientInfo_kekri_id_cmp:= LoadFuncCLibCrypto('CMS_RecipientInfo_kekri_id_cmp');
		 @CMS_RecipientInfo_set0_password:= LoadFuncCLibCrypto('CMS_RecipientInfo_set0_password');
		 @CMS_add0_recipient_password:= LoadFuncCLibCrypto('CMS_add0_recipient_password');
		 @CMS_RecipientInfo_decrypt:= LoadFuncCLibCrypto('CMS_RecipientInfo_decrypt');
		 @CMS_uncompress:= LoadFuncCLibCrypto('CMS_uncompress');
		 @CMS_compress:= LoadFuncCLibCrypto('CMS_compress');
		 @CMS_set1_eContentType:= LoadFuncCLibCrypto('CMS_set1_eContentType');
		 @CMS_get0_eContentType:= LoadFuncCLibCrypto('CMS_get0_eContentType');
		 @CMS_add0_CertificateChoices:= LoadFuncCLibCrypto('CMS_add0_CertificateChoices');
		 @CMS_add0_cert:= LoadFuncCLibCrypto('CMS_add0_cert');
		 @CMS_add1_cert:= LoadFuncCLibCrypto('CMS_add1_cert');
		 @CMS_get1_certs:= LoadFuncCLibCrypto('CMS_get1_certs');
		 @CMS_add0_RevocationInfoChoice:= LoadFuncCLibCrypto('CMS_add0_RevocationInfoChoice');
		 @CMS_add0_crl:= LoadFuncCLibCrypto('CMS_add0_crl');
		 @CMS_add1_crl:= LoadFuncCLibCrypto('CMS_add1_crl');
		 @CMS_get1_crls:= LoadFuncCLibCrypto('CMS_get1_crls');
		 @CMS_SignedData_init:= LoadFuncCLibCrypto('CMS_SignedData_init');
		 @CMS_add1_signer:= LoadFuncCLibCrypto('CMS_add1_signer');
		 @CMS_get0_SignerInfos:= LoadFuncCLibCrypto('CMS_get0_SignerInfos');
		 @CMS_SignerInfo_set1_signer_cert:= LoadFuncCLibCrypto('CMS_SignerInfo_set1_signer_cert');
		 @CMS_SignerInfo_get0_signer_id:= LoadFuncCLibCrypto('CMS_SignerInfo_get0_signer_id');
		 @CMS_SignerInfo_cert_cmp:= LoadFuncCLibCrypto('CMS_SignerInfo_cert_cmp');
		 @CMS_set1_signers_certs:= LoadFuncCLibCrypto('CMS_set1_signers_certs');
		 @CMS_SignerInfo_get0_algs:= LoadFuncCLibCrypto('CMS_SignerInfo_get0_algs');
		 @CMS_SignerInfo_sign:= LoadFuncCLibCrypto('CMS_SignerInfo_sign');
		 @CMS_SignerInfo_verify:= LoadFuncCLibCrypto('CMS_SignerInfo_verify');
		 @CMS_SignerInfo_verify_content:= LoadFuncCLibCrypto('CMS_SignerInfo_verify_content');
		 @CMS_add_smimecap:= LoadFuncCLibCrypto('CMS_add_smimecap');
		 @CMS_add_simple_smimecap:= LoadFuncCLibCrypto('CMS_add_simple_smimecap');
		 @CMS_add_standard_smimecap:= LoadFuncCLibCrypto('CMS_add_standard_smimecap');
		 @CMS_signed_get_attr_count:= LoadFuncCLibCrypto('CMS_signed_get_attr_count');
		 @CMS_signed_get_attr_by_NID:= LoadFuncCLibCrypto('CMS_signed_get_attr_by_NID');
		 @CMS_signed_get_attr_by_OBJ:= LoadFuncCLibCrypto('CMS_signed_get_attr_by_OBJ');
		 @CMS_signed_get_attr:= LoadFuncCLibCrypto('CMS_signed_get_attr');
		 @CMS_signed_delete_attr:= LoadFuncCLibCrypto('CMS_signed_delete_attr');
		 @CMS_signed_add1_attr:= LoadFuncCLibCrypto('CMS_signed_add1_attr');
		 @CMS_signed_add1_attr_by_OBJ:= LoadFuncCLibCrypto('CMS_signed_add1_attr_by_OBJ');
		 @CMS_signed_add1_attr_by_NID:= LoadFuncCLibCrypto('CMS_signed_add1_attr_by_NID');
		 @CMS_signed_add1_attr_by_txt:= LoadFuncCLibCrypto('CMS_signed_add1_attr_by_txt');
		 @CMS_signed_get0_data_by_OBJ:= LoadFuncCLibCrypto('CMS_signed_get0_data_by_OBJ');
		 @CMS_unsigned_get_attr_count:= LoadFuncCLibCrypto('CMS_unsigned_get_attr_count');
		 @CMS_unsigned_get_attr_by_NID:= LoadFuncCLibCrypto('CMS_unsigned_get_attr_by_NID');
		 @CMS_unsigned_get_attr_by_OBJ:= LoadFuncCLibCrypto('CMS_unsigned_get_attr_by_OBJ');
		 @CMS_unsigned_get_attr:= LoadFuncCLibCrypto('CMS_unsigned_get_attr');
		 @CMS_unsigned_delete_attr:= LoadFuncCLibCrypto('CMS_unsigned_delete_attr');
		 @CMS_unsigned_add1_attr:= LoadFuncCLibCrypto('CMS_unsigned_add1_attr');
		 @CMS_unsigned_add1_attr_by_OBJ:= LoadFuncCLibCrypto('CMS_unsigned_add1_attr_by_OBJ');
		 @CMS_unsigned_add1_attr_by_NID:= LoadFuncCLibCrypto('CMS_unsigned_add1_attr_by_NID');
		 @CMS_unsigned_add1_attr_by_txt:= LoadFuncCLibCrypto('CMS_unsigned_add1_attr_by_txt');
		 @CMS_unsigned_get0_data_by_OBJ:= LoadFuncCLibCrypto('CMS_unsigned_get0_data_by_OBJ');
		 @CMS_get1_ReceiptRequest:= LoadFuncCLibCrypto('CMS_get1_ReceiptRequest');
		 @CMS_ReceiptRequest_create0:= LoadFuncCLibCrypto('CMS_ReceiptRequest_create0');
		 @CMS_add1_ReceiptRequest:= LoadFuncCLibCrypto('CMS_add1_ReceiptRequest');
		 @CMS_ReceiptRequest_get0_values:= LoadFuncCLibCrypto('CMS_ReceiptRequest_get0_values');
		 @ERR_load_CMS_strings:= LoadFuncCLibCrypto('ERR_load_CMS_strings');
		 @CMS_ContentInfo_new:= LoadFuncCLibCrypto('CMS_ContentInfo_new');
		 @CMS_ContentInfo_free:= LoadFuncCLibCrypto('CMS_ContentInfo_free');
		 @d2i_CMS_ContentInfo:= LoadFuncCLibCrypto('d2i_CMS_ContentInfo');
		 @i2d_CMS_ContentInfo:= LoadFuncCLibCrypto('i2d_CMS_ContentInfo');
		 @CMS_ContentInfo_it:= LoadFuncCLibCrypto('CMS_ContentInfo_it');
		 @CMS_ReceiptRequest_new:= LoadFuncCLibCrypto('CMS_ReceiptRequest_new');
		 @CMS_ReceiptRequest_free:= LoadFuncCLibCrypto('CMS_ReceiptRequest_free');
		 @d2i_CMS_ReceiptRequest:= LoadFuncCLibCrypto('d2i_CMS_ReceiptRequest');
		 @i2d_CMS_ReceiptRequest:= LoadFuncCLibCrypto('i2d_CMS_ReceiptRequest');
		 @CMS_ReceiptRequest_it:= LoadFuncCLibCrypto('CMS_ReceiptRequest_it');
	 end;
