...
begin
  ...
  begin
     @EVP_MD_type:= LoadFuncCLibCrypto('EVP_MD_type');
     @EVP_MD_pkey_type:= LoadFuncCLibCrypto('EVP_MD_pkey_type');
     @EVP_MD_size:= LoadFuncCLibCrypto('EVP_MD_size');
     @EVP_MD_block_size:= LoadFuncCLibCrypto('EVP_MD_block_size');
     @EVP_MD_flags:= LoadFuncCLibCrypto('EVP_MD_flags', False);
     @EVP_MD_CTX_md:= LoadFuncCLibCrypto('EVP_MD_CTX_md');
     @EVP_CIPHER_nid:= LoadFuncCLibCrypto('EVP_CIPHER_nid');
     @EVP_CIPHER_block_size:= LoadFuncCLibCrypto('EVP_CIPHER_block_size');
     @EVP_CIPHER_key_length:= LoadFuncCLibCrypto('EVP_CIPHER_key_length');
     @EVP_CIPHER_iv_length:= LoadFuncCLibCrypto('EVP_CIPHER_iv_length');
     @EVP_CIPHER_flags:= LoadFuncCLibCrypto('EVP_CIPHER_flags');
     @EVP_CIPHER_CTX_cipher:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_cipher');
     @EVP_CIPHER_CTX_nid:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_nid', false);
     @EVP_CIPHER_CTX_block_size:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_block_size');
     @EVP_CIPHER_CTX_key_length:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_key_length');
     @EVP_CIPHER_CTX_iv_length:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_iv_length');
     @EVP_CIPHER_CTX_copy:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_copy', false);
     @EVP_CIPHER_CTX_get_app_data:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_get_app_data');
     @EVP_CIPHER_CTX_set_app_data:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_set_app_data');
     @EVP_CIPHER_CTX_flags:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_flags');
     @BIO_set_md:= LoadFuncCLibCrypto('BIO_set_md', false);
     @EVP_Cipher:= LoadFuncCLibCrypto('EVP_Cipher');
     @EVP_MD_CTX_init:= LoadFuncCLibCrypto('EVP_MD_CTX_init');
     @EVP_MD_CTX_cleanup:= LoadFuncCLibCrypto('EVP_MD_CTX_cleanup');
     @EVP_MD_CTX_create:= LoadFuncCLibCrypto('EVP_MD_CTX_create');
     @EVP_MD_CTX_destroy:= LoadFuncCLibCrypto('EVP_MD_CTX_destroy');
     @EVP_MD_CTX_copy_ex:= LoadFuncCLibCrypto('EVP_MD_CTX_copy_ex');
     @EVP_MD_CTX_set_flags:= LoadFuncCLibCrypto('EVP_MD_CTX_set_flags');
     @EVP_MD_CTX_clear_flags:= LoadFuncCLibCrypto('EVP_MD_CTX_clear_flags');
     @EVP_MD_CTX_test_flags:= LoadFuncCLibCrypto('EVP_MD_CTX_test_flags');
     ...
     @EVP_Digest:= LoadFuncCLibCrypto('EVP_Digest');
     @EVP_MD_CTX_copy:= LoadFuncCLibCrypto('EVP_MD_CTX_copy');
     @EVP_DigestInit:= LoadFuncCLibCrypto('EVP_DigestInit');
     @EVP_DigestFinal:= LoadFuncCLibCrypto('EVP_DigestFinal');
     @EVP_read_pw_string:= LoadFuncCLibCrypto('EVP_read_pw_string');
     @EVP_read_pw_string_min:= LoadFuncCLibCrypto('EVP_read_pw_string_min', false);
     @EVP_set_pw_prompt:= LoadFuncCLibCrypto('EVP_set_pw_prompt');
     @EVP_get_pw_prompt:= LoadFuncCLibCrypto('EVP_get_pw_prompt');
     @EVP_BytesToKey:= LoadFuncCLibCrypto('EVP_BytesToKey');
     @EVP_CIPHER_CTX_set_flags:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_set_flags');
     @EVP_CIPHER_CTX_clear_flags:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_clear_flags');
     @EVP_CIPHER_CTX_test_flags:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_test_flags');
     @EVP_EncryptInit:= LoadFuncCLibCrypto('EVP_EncryptInit');
     ...
     @EVP_EncryptFinal:= LoadFuncCLibCrypto('EVP_EncryptFinal');
     @EVP_DecryptInit:= LoadFuncCLibCrypto('EVP_DecryptInit');
     @EVP_DecryptInit_ex:= LoadFuncCLibCrypto('EVP_DecryptInit_ex');
     @EVP_DecryptUpdate:= LoadFuncCLibCrypto('EVP_DecryptUpdate');
     @EVP_DecryptFinal:= LoadFuncCLibCrypto('EVP_DecryptFinal');
     @EVP_DecryptFinal_ex:= LoadFuncCLibCrypto('EVP_DecryptFinal_ex');
     @EVP_CipherInit:= LoadFuncCLibCrypto('EVP_CipherInit');
     @EVP_CipherInit_ex:= LoadFuncCLibCrypto('EVP_CipherInit_ex');
     @EVP_CipherUpdate:= LoadFuncCLibCrypto('EVP_CipherUpdate');
     @EVP_CipherFinal:= LoadFuncCLibCrypto('EVP_CipherFinal');
     @EVP_CipherFinal_ex:= LoadFuncCLibCrypto('EVP_CipherFinal_ex');
     @EVP_SignFinal:= LoadFuncCLibCrypto('EVP_SignFinal');
     @EVP_VerifyFinal:= LoadFuncCLibCrypto('EVP_VerifyFinal');
     @EVP_DigestSignInit:= LoadFuncCLibCrypto('EVP_DigestSignInit', False);
     @EVP_DigestSignFinal:= LoadFuncCLibCrypto('EVP_DigestSignFinal', false);
     @EVP_DigestVerifyInit:= LoadFuncCLibCrypto('EVP_DigestVerifyInit', false);
     @EVP_DigestVerifyFinal:= LoadFuncCLibCrypto('EVP_DigestVerifyFinal', false);
     @EVP_OpenInit:= LoadFuncCLibCrypto('EVP_OpenInit');
     @EVP_OpenFinal:= LoadFuncCLibCrypto('EVP_OpenFinal');
     @EVP_SealInit:= LoadFuncCLibCrypto('EVP_SealInit');
     @EVP_SealFinal:= LoadFuncCLibCrypto('EVP_SealFinal');
   
     @EVP_CIPHER_CTX_init:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_init');
     @EVP_CIPHER_CTX_free:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_free');
     @EVP_CIPHER_CTX_new:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_new');
     @EVP_CIPHER_CTX_cleanup:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_cleanup');
     @EVP_CIPHER_CTX_set_key_length:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_set_key_length');
     @EVP_CIPHER_CTX_set_padding:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_set_padding');
     @EVP_CIPHER_CTX_ctrl:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_ctrl');
     @EVP_CIPHER_CTX_rand_key:= LoadFuncCLibCrypto('EVP_CIPHER_CTX_rand_key');
     @BIO_f_md:= LoadFuncCLibCrypto('BIO_f_md');
     @BIO_f_base64:= LoadFuncCLibCrypto('BIO_f_base64');
     @BIO_f_cipher:= LoadFuncCLibCrypto('BIO_f_cipher');
     @BIO_f_reliable:= LoadFuncCLibCrypto('BIO_f_reliable');
     @BIO_set_cipher:= LoadFuncCLibCrypto('BIO_set_cipher');
     @EVP_md_null:= LoadFuncCLibCrypto('EVP_md_null');
     @EVP_md2:= LoadFuncCLibCrypto('EVP_md2', false);
     @EVP_md4:= LoadFuncCLibCrypto('EVP_md4');
     @EVP_md5:= LoadFuncCLibCrypto('EVP_md5');
     @EVP_sha:= LoadFuncCLibCrypto('EVP_sha');
     @EVP_sha1:= LoadFuncCLibCrypto('EVP_sha1');
     @EVP_dss:= LoadFuncCLibCrypto('EVP_dss');
     @EVP_dss1:= LoadFuncCLibCrypto('EVP_dss1');
     @EVP_ecdsa:= LoadFuncCLibCrypto('EVP_ecdsa');
     @EVP_sha224:= LoadFuncCLibCrypto('EVP_sha224');
     @EVP_sha256:= LoadFuncCLibCrypto('EVP_sha256');
     @EVP_sha384:= LoadFuncCLibCrypto('EVP_sha384');
     @EVP_sha512:= LoadFuncCLibCrypto('EVP_sha512');
     @EVP_mdc2:= LoadFuncCLibCrypto('EVP_mdc2', false);
     @EVP_ripemd160:= LoadFuncCLibCrypto('EVP_ripemd160');
     @EVP_whirlpool:= LoadFuncCLibCrypto('EVP_whirlpool', false);
     @EVP_dev_crypto_md5:= LoadFuncCLibCrypto('EVP_dev_crypto_md5', false);
     @EVP_enc_null:= LoadFuncCLibCrypto('EVP_enc_null');
     @EVP_des_ecb:= LoadFuncCLibCrypto('EVP_des_ecb');
     @EVP_des_ede:= LoadFuncCLibCrypto('EVP_des_ede');
     @EVP_des_ede3:= LoadFuncCLibCrypto('EVP_des_ede3');
     @EVP_des_ede_ecb:= LoadFuncCLibCrypto('EVP_des_ede_ecb');
     @EVP_des_ede3_ecb:= LoadFuncCLibCrypto('EVP_des_ede3_ecb');
     @EVP_des_cfb64:= LoadFuncCLibCrypto('EVP_des_cfb64');
     @EVP_des_cfb1:= LoadFuncCLibCrypto('EVP_des_cfb1');
     @EVP_des_cfb8:= LoadFuncCLibCrypto('EVP_des_cfb8');
     @EVP_des_ede_cfb64:= LoadFuncCLibCrypto('EVP_des_ede_cfb64');
     @EVP_des_ede_cfb1:= LoadFuncCLibCrypto('EVP_des_ede_cfb1', false);
     @EVP_des_ede_cfb8:= LoadFuncCLibCrypto('EVP_des_ede_cfb8', false);
     @EVP_des_ede3_cfb64:= LoadFuncCLibCrypto('EVP_des_ede3_cfb64');
     @EVP_des_ede3_cfb1:= LoadFuncCLibCrypto('EVP_des_ede3_cfb1');
     @EVP_des_ede3_cfb8:= LoadFuncCLibCrypto('EVP_des_ede3_cfb8');
     @EVP_des_ofb:= LoadFuncCLibCrypto('EVP_des_ofb');
     @EVP_des_ede_ofb:= LoadFuncCLibCrypto('EVP_des_ede_ofb');
     @EVP_des_ede3_ofb:= LoadFuncCLibCrypto('EVP_des_ede3_ofb');
     @EVP_des_cbc:= LoadFuncCLibCrypto('EVP_des_cbc');
     @EVP_des_ede_cbc:= LoadFuncCLibCrypto('EVP_des_ede_cbc');
     @EVP_des_ede3_cbc:= LoadFuncCLibCrypto('EVP_des_ede3_cbc');
     @EVP_desx_cbc:= LoadFuncCLibCrypto('EVP_desx_cbc');
     @EVP_dev_crypto_des_ede3_cbc:= LoadFuncCLibCrypto('EVP_dev_crypto_des_ede3_cbc', false);
     @EVP_dev_crypto_rc4:= LoadFuncCLibCrypto('EVP_dev_crypto_rc4', false);
     @EVP_rc4:= LoadFuncCLibCrypto('EVP_rc4');
     @EVP_rc4_40:= LoadFuncCLibCrypto('EVP_rc4_40');
     @EVP_rc4_hmac_md5:= LoadFuncCLibCrypto('EVP_rc4_hmac_md5', false);
     @EVP_idea_ecb:= LoadFuncCLibCrypto('EVP_idea_ecb');
     @EVP_idea_cfb64:= LoadFuncCLibCrypto('EVP_idea_cfb64');
     @EVP_idea_ofb:= LoadFuncCLibCrypto('EVP_idea_ofb');
     @EVP_idea_cbc:= LoadFuncCLibCrypto('EVP_idea_cbc');
     @EVP_rc2_ecb:= LoadFuncCLibCrypto('EVP_rc2_ecb');
     @EVP_rc2_cbc:= LoadFuncCLibCrypto('EVP_rc2_cbc');
     @EVP_rc2_40_cbc:= LoadFuncCLibCrypto('EVP_rc2_40_cbc');
     @EVP_rc2_64_cbc:= LoadFuncCLibCrypto('EVP_rc2_64_cbc');
     @EVP_rc2_cfb64:= LoadFuncCLibCrypto('EVP_rc2_cfb64');
     @EVP_rc2_ofb:= LoadFuncCLibCrypto('EVP_rc2_ofb');
     @EVP_bf_ecb:= LoadFuncCLibCrypto('EVP_bf_ecb');
     @EVP_bf_cbc:= LoadFuncCLibCrypto('EVP_bf_cbc');
     @EVP_bf_cfb64:= LoadFuncCLibCrypto('EVP_bf_cfb64');
     @EVP_bf_ofb:= LoadFuncCLibCrypto('EVP_bf_ofb');
     @EVP_cast5_ecb:= LoadFuncCLibCrypto('EVP_cast5_ecb');
     @EVP_cast5_cbc:= LoadFuncCLibCrypto('EVP_cast5_cbc');
     @EVP_cast5_cfb64:= LoadFuncCLibCrypto('EVP_cast5_cfb64');
     @EVP_cast5_ofb:= LoadFuncCLibCrypto('EVP_cast5_ofb');
     @EVP_rc5_32_12_16_cbc:= LoadFuncCLibCrypto('EVP_rc5_32_12_16_cbc', false);
     @EVP_rc5_32_12_16_ecb:= LoadFuncCLibCrypto('EVP_rc5_32_12_16_ecb', false);
     @EVP_rc5_32_12_16_cfb64:= LoadFuncCLibCrypto('EVP_rc5_32_12_16_cfb64', false);
     @EVP_rc5_32_12_16_ofb:= LoadFuncCLibCrypto('EVP_rc5_32_12_16_ofb', false);
     @EVP_aes_128_ecb:= LoadFuncCLibCrypto('EVP_aes_128_ecb');
     @EVP_aes_128_cbc:= LoadFuncCLibCrypto('EVP_aes_128_cbc');
     @EVP_aes_128_cfb1:= LoadFuncCLibCrypto('EVP_aes_128_cfb1');
     @EVP_aes_128_cfb8:= LoadFuncCLibCrypto('EVP_aes_128_cfb8');
     @EVP_aes_128_cfb128:= LoadFuncCLibCrypto('EVP_aes_128_cfb128');
     @EVP_aes_128_ofb:= LoadFuncCLibCrypto('EVP_aes_128_ofb');
     @EVP_aes_128_ctr:= LoadFuncCLibCrypto('EVP_aes_128_ctr', false);
     @EVP_aes_128_gcm:= LoadFuncCLibCrypto('EVP_aes_128_gcm', false);
     @EVP_aes_128_ccm:= LoadFuncCLibCrypto('EVP_aes_128_ccm', false);
     @EVP_aes_128_xts:= LoadFuncCLibCrypto('EVP_aes_128_xts', false);
     @EVP_aes_192_ecb:= LoadFuncCLibCrypto('EVP_aes_192_ecb');
     @EVP_aes_192_cbc:= LoadFuncCLibCrypto('EVP_aes_192_cbc');
     @EVP_aes_192_cfb1:= LoadFuncCLibCrypto('EVP_aes_192_cfb1');
     @EVP_aes_192_cfb8:= LoadFuncCLibCrypto('EVP_aes_192_cfb8');
     @EVP_aes_192_cfb128:= LoadFuncCLibCrypto('EVP_aes_192_cfb128');
     @EVP_aes_192_ofb:= LoadFuncCLibCrypto('EVP_aes_192_ofb');
     @EVP_aes_192_ctr:= LoadFuncCLibCrypto('EVP_aes_192_ctr', false);
     @EVP_aes_192_gcm:= LoadFuncCLibCrypto('EVP_aes_192_gcm', false);
     @EVP_aes_192_ccm:= LoadFuncCLibCrypto('EVP_aes_192_ccm', false);
     @EVP_aes_256_ecb:= LoadFuncCLibCrypto('EVP_aes_256_ecb');
     @EVP_aes_256_cbc:= LoadFuncCLibCrypto('EVP_aes_256_cbc');
     @EVP_aes_256_cfb1:= LoadFuncCLibCrypto('EVP_aes_256_cfb1');
     @EVP_aes_256_cfb8:= LoadFuncCLibCrypto('EVP_aes_256_cfb8');
     @EVP_aes_256_cfb128:= LoadFuncCLibCrypto('EVP_aes_256_cfb128');
     @EVP_aes_256_ofb:= LoadFuncCLibCrypto('EVP_aes_256_ofb');
     @EVP_aes_256_ctr:= LoadFuncCLibCrypto('EVP_aes_256_ctr', false);
     @EVP_aes_256_gcm:= LoadFuncCLibCrypto('EVP_aes_256_gcm', false);
     @EVP_aes_256_ccm:= LoadFuncCLibCrypto('EVP_aes_256_ccm', false);
     @EVP_aes_256_xts:= LoadFuncCLibCrypto('EVP_aes_256_xts', false);
     @EVP_aes_128_cbc_hmac_sha1:= LoadFuncCLibCrypto('EVP_aes_128_cbc_hmac_sha1', false);
     @EVP_aes_256_cbc_hmac_sha1:= LoadFuncCLibCrypto('EVP_aes_256_cbc_hmac_sha1', false);
     @EVP_camellia_128_ecb:= LoadFuncCLibCrypto('EVP_camellia_128_ecb', false);
     @EVP_camellia_128_cbc:= LoadFuncCLibCrypto('EVP_camellia_128_cbc', false);
     @EVP_camellia_128_cfb1:= LoadFuncCLibCrypto('EVP_camellia_128_cfb1', false);
     @EVP_camellia_128_cfb8:= LoadFuncCLibCrypto('EVP_camellia_128_cfb8', false);
     @EVP_camellia_128_cfb128:= LoadFuncCLibCrypto('EVP_camellia_128_cfb128', false);
     @EVP_camellia_128_ofb:= LoadFuncCLibCrypto('EVP_camellia_128_ofb', false);
     @EVP_camellia_192_ecb:= LoadFuncCLibCrypto('EVP_camellia_192_ecb', false);
     @EVP_camellia_192_cbc:= LoadFuncCLibCrypto('EVP_camellia_192_cbc', false);
     @EVP_camellia_192_cfb1:= LoadFuncCLibCrypto('EVP_camellia_192_cfb1', false);
     @EVP_camellia_192_cfb8:= LoadFuncCLibCrypto('EVP_camellia_192_cfb8', false);
     @EVP_camellia_192_cfb128:= LoadFuncCLibCrypto('EVP_camellia_192_cfb128', false);
     @EVP_camellia_192_ofb:= LoadFuncCLibCrypto('EVP_camellia_192_ofb', false);
     @EVP_camellia_256_ecb:= LoadFuncCLibCrypto('EVP_camellia_256_ecb', false);
     @EVP_camellia_256_cbc:= LoadFuncCLibCrypto('EVP_camellia_256_cbc', false);
     @EVP_camellia_256_cfb1:= LoadFuncCLibCrypto('EVP_camellia_256_cfb1', false);
     @EVP_camellia_256_cfb8:= LoadFuncCLibCrypto('EVP_camellia_256_cfb8', false);
     @EVP_camellia_256_cfb128:= LoadFuncCLibCrypto('EVP_camellia_256_cfb128', false);
     @EVP_camellia_256_ofb:= LoadFuncCLibCrypto('EVP_camellia_256_ofb', false);
     @EVP_seed_ecb:= LoadFuncCLibCrypto('EVP_seed_ecb', false);
     @EVP_seed_cbc:= LoadFuncCLibCrypto('EVP_seed_cbc', false);
     @EVP_seed_cfb128:= LoadFuncCLibCrypto('EVP_seed_cfb128', false);
     @EVP_seed_ofb:= LoadFuncCLibCrypto('EVP_seed_ofb', false);
     @OPENSSL_add_all_algorithms_noconf:= LoadFuncCLibCrypto('OPENSSL_add_all_algorithms_noconf');
     @OPENSSL_add_all_algorithms_conf:= LoadFuncCLibCrypto('OPENSSL_add_all_algorithms_conf');
     @OpenSSL_add_all_ciphers:= LoadFuncCLibCrypto('OpenSSL_add_all_ciphers');
     @OpenSSL_add_all_digests:= LoadFuncCLibCrypto('OpenSSL_add_all_digests');
     @EVP_add_cipher:= LoadFuncCLibCrypto('EVP_add_cipher');
     @EVP_add_digest:= LoadFuncCLibCrypto('EVP_add_digest');
     @EVP_get_cipherbyname:= LoadFuncCLibCrypto('EVP_get_cipherbyname');
     @EVP_get_digestbyname:= LoadFuncCLibCrypto('EVP_get_digestbyname');
     @EVP_cleanup:= LoadFuncCLibCrypto('EVP_cleanup');
     @EVP_CIPHER_do_all:= LoadFuncCLibCrypto('EVP_CIPHER_do_all', false);
     @EVP_CIPHER_do_all_sorted:= LoadFuncCLibCrypto('EVP_CIPHER_do_all_sorted', false);
     @EVP_MD_do_all:= LoadFuncCLibCrypto('EVP_MD_do_all', false);
     @EVP_MD_do_all_sorted:= LoadFuncCLibCrypto('EVP_MD_do_all_sorted', false);
     @EVP_PKEY_decrypt_old:= LoadFuncCLibCrypto('EVP_PKEY_decrypt_old', false);
     @EVP_PKEY_encrypt_old:= LoadFuncCLibCrypto('EVP_PKEY_encrypt_old', false);
     @EVP_PKEY_type:= LoadFuncCLibCrypto('EVP_PKEY_type');
     @EVP_PKEY_id:= LoadFuncCLibCrypto('EVP_PKEY_id', false);
     @EVP_PKEY_base_id:= LoadFuncCLibCrypto('EVP_PKEY_base_id', false);
     @EVP_PKEY_bits:= LoadFuncCLibCrypto('EVP_PKEY_bits');
     @EVP_PKEY_size:= LoadFuncCLibCrypto('EVP_PKEY_size');
     @EVP_PKEY_set_type:= LoadFuncCLibCrypto('EVP_PKEY_set_type', false);
     @EVP_PKEY_set_type_str:= LoadFuncCLibCrypto('EVP_PKEY_set_type_str', false);
     @EVP_PKEY_assign:= LoadFuncCLibCrypto('EVP_PKEY_assign');
     @EVP_PKEY_get0:= LoadFuncCLibCrypto('EVP_PKEY_get0', false);
     @EVP_PKEY_set1_RSA:= LoadFuncCLibCrypto('EVP_PKEY_set1_RSA');
     @EVP_PKEY_get1_RSA:= LoadFuncCLibCrypto('EVP_PKEY_get1_RSA');
     @EVP_PKEY_set1_DSA:= LoadFuncCLibCrypto('EVP_PKEY_set1_DSA');
     @EVP_PKEY_get1_DSA:= LoadFuncCLibCrypto('EVP_PKEY_get1_DSA');
     @EVP_PKEY_set1_DH:= LoadFuncCLibCrypto('EVP_PKEY_set1_DH');
     @EVP_PKEY_get1_DH:= LoadFuncCLibCrypto('EVP_PKEY_get1_DH');
     @EVP_PKEY_set1_EC_KEY:= LoadFuncCLibCrypto('EVP_PKEY_set1_EC_KEY');
     @EVP_PKEY_get1_EC_KEY:= LoadFuncCLibCrypto('EVP_PKEY_get1_EC_KEY');
     @EVP_PKEY_new:= LoadFuncCLibCrypto('EVP_PKEY_new');
     @EVP_PKEY_free:= LoadFuncCLibCrypto('EVP_PKEY_free');
     @d2i_PublicKey:= LoadFuncCLibCrypto('d2i_PublicKey');
     @i2d_PublicKey:= LoadFuncCLibCrypto('i2d_PublicKey');
     @d2i_PrivateKey:= LoadFuncCLibCrypto('d2i_PrivateKey');
     @d2i_AutoPrivateKey:= LoadFuncCLibCrypto('d2i_AutoPrivateKey');
     @i2d_PrivateKey:= LoadFuncCLibCrypto('i2d_PrivateKey');
     @EVP_PKEY_copy_parameters:= LoadFuncCLibCrypto('EVP_PKEY_copy_parameters');
     @EVP_PKEY_missing_parameters:= LoadFuncCLibCrypto('EVP_PKEY_missing_parameters');
     @EVP_PKEY_save_parameters:= LoadFuncCLibCrypto('EVP_PKEY_save_parameters');
     @EVP_PKEY_cmp_parameters:= LoadFuncCLibCrypto('EVP_PKEY_cmp_parameters');
     @EVP_PKEY_cmp:= LoadFuncCLibCrypto('EVP_PKEY_cmp');
     @EVP_PKEY_print_public:= LoadFuncCLibCrypto('EVP_PKEY_print_public', false);
     @EVP_PKEY_print_private:= LoadFuncCLibCrypto('EVP_PKEY_print_private', false);
     @EVP_PKEY_print_params:= LoadFuncCLibCrypto('EVP_PKEY_print_params', false);
     @EVP_PKEY_get_default_digest_nid:= LoadFuncCLibCrypto('EVP_PKEY_get_default_digest_nid', false);
     @EVP_CIPHER_type:= LoadFuncCLibCrypto('EVP_CIPHER_type');
     @EVP_CIPHER_param_to_asn1:= LoadFuncCLibCrypto('EVP_CIPHER_param_to_asn1');
     @EVP_CIPHER_asn1_to_param:= LoadFuncCLibCrypto('EVP_CIPHER_asn1_to_param');
     @EVP_CIPHER_set_asn1_iv:= LoadFuncCLibCrypto('EVP_CIPHER_set_asn1_iv');
     @EVP_CIPHER_get_asn1_iv:= LoadFuncCLibCrypto('EVP_CIPHER_get_asn1_iv');
     @PKCS5_PBE_keyivgen:= LoadFuncCLibCrypto('PKCS5_PBE_keyivgen');
     @PKCS5_PBKDF2_HMAC_SHA1:= LoadFuncCLibCrypto('PKCS5_PBKDF2_HMAC_SHA1');
     @PKCS5_PBKDF2_HMAC:= LoadFuncCLibCrypto('PKCS5_PBKDF2_HMAC', false);
     @PKCS5_v2_PBE_keyivgen:= LoadFuncCLibCrypto('PKCS5_v2_PBE_keyivgen');
     @PKCS5_PBE_add:= LoadFuncCLibCrypto('PKCS5_PBE_add');
     @EVP_PBE_CipherInit:= LoadFuncCLibCrypto('EVP_PBE_CipherInit');
     @EVP_PBE_alg_add_type:= LoadFuncCLibCrypto('EVP_PBE_alg_add_type', false);
     @EVP_PBE_alg_add:= LoadFuncCLibCrypto('EVP_PBE_alg_add');
     @EVP_PBE_find:= LoadFuncCLibCrypto('EVP_PBE_find', false);
     @EVP_PBE_cleanup:= LoadFuncCLibCrypto('EVP_PBE_cleanup');
     @EVP_PKEY_asn1_get_count:= LoadFuncCLibCrypto('EVP_PKEY_asn1_get_count', false);
     @EVP_PKEY_asn1_get0:= LoadFuncCLibCrypto('EVP_PKEY_asn1_get0', false);
     @EVP_PKEY_asn1_find:= LoadFuncCLibCrypto('EVP_PKEY_asn1_find', false);
     @EVP_PKEY_asn1_find_str:= LoadFuncCLibCrypto('EVP_PKEY_asn1_find_str', false);
     @EVP_PKEY_asn1_add0:= LoadFuncCLibCrypto('EVP_PKEY_asn1_add0', false);
     @EVP_PKEY_asn1_add_alias:= LoadFuncCLibCrypto('EVP_PKEY_asn1_add_alias', false);
     @EVP_PKEY_asn1_get0_info:= LoadFuncCLibCrypto('EVP_PKEY_asn1_get0_info', false);
     @EVP_PKEY_get0_asn1:= LoadFuncCLibCrypto('EVP_PKEY_get0_asn1', false);
     @EVP_PKEY_asn1_new:= LoadFuncCLibCrypto('EVP_PKEY_asn1_new', false);
     @EVP_PKEY_asn1_copy:= LoadFuncCLibCrypto('EVP_PKEY_asn1_copy', false);
     @EVP_PKEY_asn1_free:= LoadFuncCLibCrypto('EVP_PKEY_asn1_free', false);
     @EVP_PKEY_asn1_set_public:= LoadFuncCLibCrypto('EVP_PKEY_asn1_set_public', false);
     @EVP_PKEY_asn1_set_private:= LoadFuncCLibCrypto('EVP_PKEY_asn1_set_private', false);
     @EVP_PKEY_asn1_set_param:= LoadFuncCLibCrypto('EVP_PKEY_asn1_set_param', false);
     @EVP_PKEY_asn1_set_free:= LoadFuncCLibCrypto('EVP_PKEY_asn1_set_free', false);
     @EVP_PKEY_asn1_set_ctrl:= LoadFuncCLibCrypto('EVP_PKEY_asn1_set_ctrl', false);
     @EVP_PKEY_meth_find:= LoadFuncCLibCrypto('EVP_PKEY_meth_find', false);
     @EVP_PKEY_meth_new:= LoadFuncCLibCrypto('EVP_PKEY_meth_new', false);
     @EVP_PKEY_meth_get0_info:= LoadFuncCLibCrypto('EVP_PKEY_meth_get0_info', false);
     @EVP_PKEY_meth_copy:= LoadFuncCLibCrypto('EVP_PKEY_meth_copy', false);
     @EVP_PKEY_meth_free:= LoadFuncCLibCrypto('EVP_PKEY_meth_free', false);
     @EVP_PKEY_meth_add0:= LoadFuncCLibCrypto('EVP_PKEY_meth_add0', false);
     @EVP_PKEY_CTX_new:= LoadFuncCLibCrypto('EVP_PKEY_CTX_new', false);
     @EVP_PKEY_CTX_new_id:= LoadFuncCLibCrypto('EVP_PKEY_CTX_new_id', false);
     @EVP_PKEY_CTX_dup:= LoadFuncCLibCrypto('EVP_PKEY_CTX_dup', false);
     @EVP_PKEY_CTX_free:= LoadFuncCLibCrypto('EVP_PKEY_CTX_free', false);
     @EVP_PKEY_CTX_set0_keygen_info:= LoadFuncCLibCrypto('EVP_PKEY_CTX_set0_keygen_info', false);
     @EVP_PKEY_CTX_set_data:= LoadFuncCLibCrypto('EVP_PKEY_CTX_set_data', false);
     @EVP_PKEY_CTX_set_app_data:= LoadFuncCLibCrypto('EVP_PKEY_CTX_set_app_data', false);
     @EVP_PKEY_CTX_ctrl:= LoadFuncCLibCrypto('EVP_PKEY_CTX_ctrl', false);
     @EVP_PKEY_CTX_ctrl_str:= LoadFuncCLibCrypto('EVP_PKEY_CTX_ctrl_str', false);
     @EVP_PKEY_CTX_get_operation:= LoadFuncCLibCrypto('EVP_PKEY_CTX_get_operation', false);
     @EVP_PKEY_new_mac_key:= LoadFuncCLibCrypto('EVP_PKEY_new_mac_key', false);
     @EVP_PKEY_CTX_get_data:= LoadFuncCLibCrypto('EVP_PKEY_CTX_get_data', false);
     @EVP_PKEY_CTX_get0_pkey:= LoadFuncCLibCrypto('EVP_PKEY_CTX_get0_pkey', false);
     @EVP_PKEY_CTX_get0_peerkey:= LoadFuncCLibCrypto('EVP_PKEY_CTX_get0_peerkey', false);
     @EVP_PKEY_CTX_get_app_data:= LoadFuncCLibCrypto('EVP_PKEY_CTX_get_app_data', false);
     @EVP_PKEY_sign_init:= LoadFuncCLibCrypto('EVP_PKEY_sign_init', false);
     @EVP_PKEY_sign:= LoadFuncCLibCrypto('EVP_PKEY_sign', false);
     @EVP_PKEY_verify_init:= LoadFuncCLibCrypto('EVP_PKEY_verify_init', false);
     @EVP_PKEY_verify:= LoadFuncCLibCrypto('EVP_PKEY_verify', false);
     @EVP_PKEY_verify_recover_init:= LoadFuncCLibCrypto('EVP_PKEY_verify_recover_init', false);
     @EVP_PKEY_verify_recover:= LoadFuncCLibCrypto('EVP_PKEY_verify_recover', false);
     @EVP_PKEY_encrypt_init:= LoadFuncCLibCrypto('EVP_PKEY_encrypt_init', false);
     @EVP_PKEY_encrypt:= LoadFuncCLibCrypto('EVP_PKEY_encrypt', false);
     @EVP_PKEY_decrypt_init:= LoadFuncCLibCrypto('EVP_PKEY_decrypt_init', false);
     @EVP_PKEY_decrypt:= LoadFuncCLibCrypto('EVP_PKEY_decrypt', false);
     @EVP_PKEY_derive_init:= LoadFuncCLibCrypto('EVP_PKEY_derive_init', false);
     @EVP_PKEY_derive_set_peer:= LoadFuncCLibCrypto('EVP_PKEY_derive_set_peer', false);
     @EVP_PKEY_derive:= LoadFuncCLibCrypto('EVP_PKEY_derive', false);
     @EVP_PKEY_paramgen_init:= LoadFuncCLibCrypto('EVP_PKEY_paramgen_init', false);
     @EVP_PKEY_paramgen:= LoadFuncCLibCrypto('EVP_PKEY_paramgen', false);
     @EVP_PKEY_keygen_init:= LoadFuncCLibCrypto('EVP_PKEY_keygen_init', false);
     @EVP_PKEY_keygen:= LoadFuncCLibCrypto('EVP_PKEY_keygen', false);
     @EVP_PKEY_CTX_set_cb:= LoadFuncCLibCrypto('EVP_PKEY_CTX_set_cb', false);
     @EVP_PKEY_CTX_get_cb:= LoadFuncCLibCrypto('EVP_PKEY_CTX_get_cb', false);
     @EVP_PKEY_CTX_get_keygen_info:= LoadFuncCLibCrypto('EVP_PKEY_CTX_get_keygen_info', false);
     @ERR_load_EVP_strings:= LoadFuncCLibCrypto('ERR_load_EVP_strings');
