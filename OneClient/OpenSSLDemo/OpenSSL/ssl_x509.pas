...
begin
 if @X509_new = nil then
  begin
    @X509_new := LoadFuncCLibCrypto('X509_new');
    @X509_free := LoadFuncCLibCrypto('X509_free');
    @X509_NAME_new := LoadFuncCLibCrypto('X509_NAME_new');
    @X509_NAME_free := LoadFuncCLibCrypto('X509_NAME_free');
    @X509_REQ_new := LoadFuncCLibCrypto('X509_REQ_new');
    @X509_REQ_free := LoadFuncCLibCrypto('X509_REQ_free');
    @X509_to_X509_REQ := LoadFuncCLibCrypto('X509_to_X509_REQ');
    @X509_NAME_add_entry_by_txt := LoadFuncCLibCrypto('X509_NAME_add_entry_by_txt');
    @X509_INFO_free := LoadFuncCLibCrypto('X509_INFO_free');
    @X509_set_version := LoadFuncCLibCrypto('X509_set_version');
    @X509_get_serialNumber := LoadFuncCLibCrypto('X509_get_serialNumber');
    @X509_gmtime_adj := LoadFuncCLibCrypto('X509_gmtime_adj');
    @X509_set_notBefore := LoadFuncCLibCrypto('X509_set_notBefore');
    @X509_set_notAfter := LoadFuncCLibCrypto('X509_set_notAfter');
    @X509_set_pubkey := LoadFuncCLibCrypto('X509_set_pubkey');
    @X509_REQ_set_pubkey := LoadFuncCLibCrypto('X509_REQ_set_pubkey');
    @X509_sign := LoadFuncCLibCrypto('X509_sign');
    @X509_REQ_sign := LoadFuncCLibCrypto('X509_REQ_sign');
    @X509_REQ_add_extensions := LoadFuncCLibCrypto('X509_REQ_add_extensions');
    @X509V3_EXT_conf_nid := LoadFuncCLibCrypto('X509V3_EXT_conf_nid');
    @X509_EXTENSION_create_by_NID := LoadFuncCLibCrypto('X509_EXTENSION_create_by_NID');
    @X509V3_set_ctx := LoadFuncCLibCrypto('X509V3_set_ctx');
    @X509_EXTENSION_free := LoadFuncCLibCrypto('X509_EXTENSION_free');
    @X509_add_ext := LoadFuncCLibCrypto('X509_add_ext');
    @X509_print := LoadFuncCLibCrypto('X509_print');
    @X509_STORE_add_lookup := LoadFuncCLibCrypto('X509_STORE_add_lookup');
    @X509_STORE_load_locations := LoadFuncCLibCrypto('X509_STORE_load_locations');

    @i2d_PUBKEY_bio:= LoadFuncCLibCrypto('i2d_PUBKEY_bio');
    @d2i_PUBKEY_bio:= LoadFuncCLibCrypto('d2i_PUBKEY_bio');
    @i2d_PrivateKey_bio:= LoadFuncCLibCrypto('i2d_PrivateKey_bio');
    @d2i_PrivateKey_bio:= LoadFuncCLibCrypto('d2i_PrivateKey_bio');

    @X509_CRL_set_default_method:= LoadFuncCLibCrypto('X509_CRL_set_default_method');
    @X509_CRL_METHOD_free:= LoadFuncCLibCrypto('X509_CRL_METHOD_free');
    @X509_CRL_set_meth_data:= LoadFuncCLibCrypto('X509_CRL_set_meth_data');
    @X509_CRL_get_meth_data:= LoadFuncCLibCrypto('X509_CRL_get_meth_data');
    @X509_verify_cert_error_string:= LoadFuncCLibCrypto('X509_verify_cert_error_string');
    @X509_verify:= LoadFuncCLibCrypto('X509_verify');
    @X509_REQ_verify:= LoadFuncCLibCrypto('X509_REQ_verify');
    @X509_CRL_verify:= LoadFuncCLibCrypto('X509_CRL_verify');
    @NETSCAPE_SPKI_verify:= LoadFuncCLibCrypto('NETSCAPE_SPKI_verify');
    @NETSCAPE_SPKI_b64_decode:= LoadFuncCLibCrypto('NETSCAPE_SPKI_b64_decode');
    @NETSCAPE_SPKI_b64_encode:= LoadFuncCLibCrypto('NETSCAPE_SPKI_b64_encode');
    @NETSCAPE_SPKI_get_pubkey:= LoadFuncCLibCrypto('NETSCAPE_SPKI_get_pubkey');
    @NETSCAPE_SPKI_set_pubkey:= LoadFuncCLibCrypto('NETSCAPE_SPKI_set_pubkey');
    @NETSCAPE_SPKI_print:= LoadFuncCLibCrypto('NETSCAPE_SPKI_print');
    @X509_signature_dump:= LoadFuncCLibCrypto('X509_signature_dump');
    @X509_signature_print:= LoadFuncCLibCrypto('X509_signature_print');
    @X509_sign_ctx:= LoadFuncCLibCrypto('X509_sign_ctx');
    @X509_REQ_sign_ctx:= LoadFuncCLibCrypto('X509_REQ_sign_ctx');
    @X509_CRL_sign:= LoadFuncCLibCrypto('X509_CRL_sign');
    @X509_CRL_sign_ctx:= LoadFuncCLibCrypto('X509_CRL_sign_ctx');
    @NETSCAPE_SPKI_sign:= LoadFuncCLibCrypto('NETSCAPE_SPKI_sign');
    @X509_pubkey_digest:= LoadFuncCLibCrypto('X509_pubkey_digest');
    @X509_digest:= LoadFuncCLibCrypto('X509_digest');
    @X509_CRL_digest:= LoadFuncCLibCrypto('X509_CRL_digest');
    @X509_REQ_digest:= LoadFuncCLibCrypto('X509_REQ_digest');
    @X509_NAME_digest:= LoadFuncCLibCrypto('X509_NAME_digest');
    @d2i_X509_bio:= LoadFuncCLibCrypto('d2i_X509_bio');
    @i2d_X509_bio:= LoadFuncCLibCrypto('i2d_X509_bio');
    @d2i_X509_CRL_bio:= LoadFuncCLibCrypto('d2i_X509_CRL_bio');
    @i2d_X509_CRL_bio:= LoadFuncCLibCrypto('i2d_X509_CRL_bio');
    @d2i_X509_REQ_bio:= LoadFuncCLibCrypto('d2i_X509_REQ_bio');
    @i2d_X509_REQ_bio:= LoadFuncCLibCrypto('i2d_X509_REQ_bio');
    @d2i_RSAPrivateKey_bio:= LoadFuncCLibCrypto('d2i_RSAPrivateKey_bio');
    @i2d_RSAPrivateKey_bio:= LoadFuncCLibCrypto('i2d_RSAPrivateKey_bio');
    @d2i_RSAPublicKey_bio:= LoadFuncCLibCrypto('d2i_RSAPublicKey_bio');
    @i2d_RSAPublicKey_bio:= LoadFuncCLibCrypto('i2d_RSAPublicKey_bio');
    @d2i_RSA_PUBKEY_bio:= LoadFuncCLibCrypto('d2i_RSA_PUBKEY_bio');
    @i2d_RSA_PUBKEY_bio:= LoadFuncCLibCrypto('i2d_RSA_PUBKEY_bio');
    @d2i_DSA_PUBKEY_bio:= LoadFuncCLibCrypto('d2i_DSA_PUBKEY_bio');
    @i2d_DSA_PUBKEY_bio:= LoadFuncCLibCrypto('i2d_DSA_PUBKEY_bio');
    @d2i_DSAPrivateKey_bio:= LoadFuncCLibCrypto('d2i_DSAPrivateKey_bio');
    @i2d_DSAPrivateKey_bio:= LoadFuncCLibCrypto('i2d_DSAPrivateKey_bio');
    @d2i_EC_PUBKEY_bio:= LoadFuncCLibCrypto('d2i_EC_PUBKEY_bio');
    @i2d_EC_PUBKEY_bio:= LoadFuncCLibCrypto('i2d_EC_PUBKEY_bio');
    @d2i_ECPrivateKey_bio:= LoadFuncCLibCrypto('d2i_ECPrivateKey_bio');
    @i2d_ECPrivateKey_bio:= LoadFuncCLibCrypto('i2d_ECPrivateKey_bio');
    @d2i_PKCS8_bio:= LoadFuncCLibCrypto('d2i_PKCS8_bio');
    @i2d_PKCS8_bio:= LoadFuncCLibCrypto('i2d_PKCS8_bio');
    @d2i_PKCS8_PRIV_KEY_INFO_bio:= LoadFuncCLibCrypto('d2i_PKCS8_PRIV_KEY_INFO_bio');
    @i2d_PKCS8_PRIV_KEY_INFO_bio:= LoadFuncCLibCrypto('i2d_PKCS8_PRIV_KEY_INFO_bio');
    @i2d_PKCS8PrivateKeyInfo_bio:= LoadFuncCLibCrypto('i2d_PKCS8PrivateKeyInfo_bio');

    @X509_dup:= LoadFuncCLibCrypto('X509_dup');
    @X509_ATTRIBUTE_dup:= LoadFuncCLibCrypto('X509_ATTRIBUTE_dup');
    @X509_EXTENSION_dup:= LoadFuncCLibCrypto('X509_EXTENSION_dup');
    @X509_CRL_dup:= LoadFuncCLibCrypto('X509_CRL_dup');
    @X509_REQ_dup:= LoadFuncCLibCrypto('X509_REQ_dup');

    @X509_ALGOR_new:= LoadFuncCLibCrypto('X509_ALGOR_new');
    @X509_ALGOR_free:= LoadFuncCLibCrypto('X509_ALGOR_free');
    @X509_ALGOR_dup:= LoadFuncCLibCrypto('X509_ALGOR_dup');
    @X509_ALGOR_set0:= LoadFuncCLibCrypto('X509_ALGOR_set0');
    @X509_ALGOR_get0:= LoadFuncCLibCrypto('X509_ALGOR_get0');
    @X509_ALGOR_set_md:= LoadFuncCLibCrypto('X509_ALGOR_set_md');
    @X509_ALGOR_it := LoadFuncCLibCrypto('X509_ALGOR_it');
    @d2i_X509_ALGOR:= LoadFuncCLibCrypto('d2i_X509_ALGOR');
    @i2d_X509_ALGOR:= LoadFuncCLibCrypto('i2d_X509_ALGOR');

    @X509_NAME_dup:= LoadFuncCLibCrypto('X509_NAME_dup');
    @X509_NAME_ENTRY_dup:= LoadFuncCLibCrypto('X509_NAME_ENTRY_dup');
    @X509_cmp_time:= LoadFuncCLibCrypto('X509_cmp_time');
    @X509_cmp_current_time:= LoadFuncCLibCrypto('X509_cmp_current_time');
    @X509_time_adj:= LoadFuncCLibCrypto('X509_time_adj');
    @X509_time_adj_ex:= LoadFuncCLibCrypto('X509_time_adj_ex');
    @X509_gmtime_adj:= LoadFuncCLibCrypto('X509_gmtime_adj');
    @X509_get_default_cert_area:= LoadFuncCLibCrypto('X509_get_default_cert_area');
    @X509_get_default_cert_dir:= LoadFuncCLibCrypto('X509_get_default_cert_dir');
    @X509_get_default_cert_file:= LoadFuncCLibCrypto('X509_get_default_cert_file');
    @X509_get_default_cert_dir_env:= LoadFuncCLibCrypto('X509_get_default_cert_dir_env');
    @X509_get_default_cert_file_env:= LoadFuncCLibCrypto('X509_get_default_cert_file_env');
    @X509_get_default_private_dir:= LoadFuncCLibCrypto('X509_get_default_private_dir');
    @X509_to_X509_REQ:= LoadFuncCLibCrypto('X509_to_X509_REQ');
    @X509_REQ_to_X509:= LoadFuncCLibCrypto('X509_REQ_to_X509');
    @X509_PUBKEY_set:= LoadFuncCLibCrypto('X509_PUBKEY_set');
    @X509_PUBKEY_get:= LoadFuncCLibCrypto('X509_PUBKEY_get');
    @X509_get_pubkey_parameters:= LoadFuncCLibCrypto('X509_get_pubkey_parameters');
    @i2d_PUBKEY:= LoadFuncCLibCrypto('i2d_PUBKEY');
    @d2i_PUBKEY:= LoadFuncCLibCrypto('d2i_PUBKEY');
    @i2d_RSA_PUBKEY:= LoadFuncCLibCrypto('i2d_RSA_PUBKEY');
    @d2i_RSA_PUBKEY:= LoadFuncCLibCrypto('d2i_RSA_PUBKEY');
    @i2d_DSA_PUBKEY:= LoadFuncCLibCrypto('i2d_DSA_PUBKEY');
    @d2i_DSA_PUBKEY:= LoadFuncCLibCrypto('d2i_DSA_PUBKEY');
    @i2d_EC_PUBKEY:= LoadFuncCLibCrypto('i2d_EC_PUBKEY');
    @d2i_EC_PUBKEY:= LoadFuncCLibCrypto('d2i_EC_PUBKEY');
    @X509_NAME_set:= LoadFuncCLibCrypto('X509_NAME_set');
    @X509_get_ex_new_index:= LoadFuncCLibCrypto('X509_get_ex_new_index');
    @X509_set_ex_data:= LoadFuncCLibCrypto('X509_set_ex_data');
    @X509_get_ex_data:= LoadFuncCLibCrypto('X509_get_ex_data');
    @i2d_X509_AUX:= LoadFuncCLibCrypto('i2d_X509_AUX');
    @d2i_X509_AUX:= LoadFuncCLibCrypto('d2i_X509_AUX');
    @X509_alias_set1:= LoadFuncCLibCrypto('X509_alias_set1');
    @X509_keyid_set1:= LoadFuncCLibCrypto('X509_keyid_set1');
    @X509_alias_get0:= LoadFuncCLibCrypto('X509_alias_get0');
    @X509_keyid_get0:= LoadFuncCLibCrypto('X509_keyid_get0');
    @X509_TRUST_set:= LoadFuncCLibCrypto('X509_TRUST_set');
    @X509_add1_trust_object:= LoadFuncCLibCrypto('X509_add1_trust_object');
    @X509_add1_reject_object:= LoadFuncCLibCrypto('X509_add1_reject_object');
    @X509_trust_clear:= LoadFuncCLibCrypto('X509_trust_clear');
    @X509_reject_clear:= LoadFuncCLibCrypto('X509_reject_clear');
    @X509_CRL_add0_revoked:= LoadFuncCLibCrypto('X509_CRL_add0_revoked');
    @X509_CRL_get0_by_serial:= LoadFuncCLibCrypto('X509_CRL_get0_by_serial');
    @X509_CRL_get0_by_cert:= LoadFuncCLibCrypto('X509_CRL_get0_by_cert');
    @X509_PKEY_new:= LoadFuncCLibCrypto('X509_PKEY_new');
    @X509_PKEY_free:= LoadFuncCLibCrypto('X509_PKEY_free');
    @i2d_X509_PKEY:= LoadFuncCLibCrypto('i2d_X509_PKEY');
    @d2i_X509_PKEY:= LoadFuncCLibCrypto('d2i_X509_PKEY');
    @X509_INFO_new:= LoadFuncCLibCrypto('X509_INFO_new');
    @X509_INFO_free:= LoadFuncCLibCrypto('X509_INFO_free');
    @X509_NAME_oneline:= LoadFuncCLibCrypto('X509_NAME_oneline');
    ...
    @X509_set_version:= LoadFuncCLibCrypto('X509_set_version');
    @X509_set_serialNumber:= LoadFuncCLibCrypto('X509_set_serialNumber');
    @X509_get_serialNumber:= LoadFuncCLibCrypto('X509_get_serialNumber');
    @X509_set_issuer_name:= LoadFuncCLibCrypto('X509_set_issuer_name');
    @X509_get_issuer_name:= LoadFuncCLibCrypto('X509_get_issuer_name');
    @X509_set_subject_name:= LoadFuncCLibCrypto('X509_set_subject_name');
    @X509_get_subject_name:= LoadFuncCLibCrypto('X509_get_subject_name');
    @X509_set_notBefore:= LoadFuncCLibCrypto('X509_set_notBefore');
    @X509_set_notAfter:= LoadFuncCLibCrypto('X509_set_notAfter');
    @X509_set_pubkey:= LoadFuncCLibCrypto('X509_set_pubkey');
    @X509_get_pubkey:= LoadFuncCLibCrypto('X509_get_pubkey');
    @X509_get0_pubkey_bitstr:= LoadFuncCLibCrypto('X509_get0_pubkey_bitstr');
    @X509_certificate_type:= LoadFuncCLibCrypto('X509_certificate_type');
    @X509_REQ_set_version:= LoadFuncCLibCrypto('X509_REQ_set_version');
    @X509_REQ_set_subject_name:= LoadFuncCLibCrypto('X509_REQ_set_subject_name');
    @X509_REQ_set_pubkey:= LoadFuncCLibCrypto('X509_REQ_set_pubkey');
    @X509_REQ_get_pubkey:= LoadFuncCLibCrypto('X509_REQ_get_pubkey');
    @X509_REQ_extension_nid:= LoadFuncCLibCrypto('X509_REQ_extension_nid');
    @X509_REQ_get_extension_nids:= LoadFuncCLibCrypto('X509_REQ_get_extension_nids');
    @X509_REQ_set_extension_nids:= LoadFuncCLibCrypto('X509_REQ_set_extension_nids');
    @X509_REQ_get_extensions:= LoadFuncCLibCrypto('X509_REQ_get_extensions');
    @X509_REQ_add_extensions_nid:= LoadFuncCLibCrypto('X509_REQ_add_extensions_nid');
    @X509_REQ_add_extensions:= LoadFuncCLibCrypto('X509_REQ_add_extensions');
    @X509_REQ_get_attr_count:= LoadFuncCLibCrypto('X509_REQ_get_attr_count');
    @X509_REQ_get_attr_by_NID:= LoadFuncCLibCrypto('X509_REQ_get_attr_by_NID');
    @X509_REQ_get_attr_by_OBJ:= LoadFuncCLibCrypto('X509_REQ_get_attr_by_OBJ');
    @X509_REQ_get_attr:= LoadFuncCLibCrypto('X509_REQ_get_attr');
    @X509_REQ_delete_attr:= LoadFuncCLibCrypto('X509_REQ_delete_attr');
    @X509_REQ_add1_attr:= LoadFuncCLibCrypto('X509_REQ_add1_attr');
    @X509_REQ_add1_attr_by_OBJ:= LoadFuncCLibCrypto('X509_REQ_add1_attr_by_OBJ');
    @X509_REQ_add1_attr_by_NID:= LoadFuncCLibCrypto('X509_REQ_add1_attr_by_NID');
    @X509_REQ_add1_attr_by_txt:= LoadFuncCLibCrypto('X509_REQ_add1_attr_by_txt');
    @X509_CRL_set_version:= LoadFuncCLibCrypto('X509_CRL_set_version');
    @X509_CRL_set_issuer_name:= LoadFuncCLibCrypto('X509_CRL_set_issuer_name');
    @X509_CRL_set_lastUpdate:= LoadFuncCLibCrypto('X509_CRL_set_lastUpdate');
    @X509_CRL_set_nextUpdate:= LoadFuncCLibCrypto('X509_CRL_set_nextUpdate');
    @X509_CRL_sort:= LoadFuncCLibCrypto('X509_CRL_sort');
    @X509_REVOKED_set_serialNumber:= LoadFuncCLibCrypto('X509_REVOKED_set_serialNumber');
    @X509_REVOKED_set_revocationDate:= LoadFuncCLibCrypto('X509_REVOKED_set_revocationDate');
    @X509_REQ_check_private_key:= LoadFuncCLibCrypto('X509_REQ_check_private_key');
    @X509_check_private_key:= LoadFuncCLibCrypto('X509_check_private_key');
    @X509_issuer_and_serial_cmp:= LoadFuncCLibCrypto('X509_issuer_and_serial_cmp');
    @X509_issuer_and_serial_hash:= LoadFuncCLibCrypto('X509_issuer_and_serial_hash');
    @X509_issuer_name_cmp:= LoadFuncCLibCrypto('X509_issuer_name_cmp');
    @X509_issuer_name_hash:= LoadFuncCLibCrypto('X509_issuer_name_hash');
    @X509_subject_name_cmp:= LoadFuncCLibCrypto('X509_subject_name_cmp');
    @X509_subject_name_hash:= LoadFuncCLibCrypto('X509_subject_name_hash');
    @X509_issuer_name_hash_old:= LoadFuncCLibCrypto('X509_issuer_name_hash_old');
    @X509_subject_name_hash_old:= LoadFuncCLibCrypto('X509_subject_name_hash_old');
    @X509_cmp:= LoadFuncCLibCrypto('X509_cmp');
    @X509_NAME_cmp:= LoadFuncCLibCrypto('X509_NAME_cmp');
    @X509_NAME_hash:= LoadFuncCLibCrypto('X509_NAME_hash');
    @X509_NAME_hash_old:= LoadFuncCLibCrypto('X509_NAME_hash_old');
    @X509_CRL_cmp:= LoadFuncCLibCrypto('X509_CRL_cmp');
    @X509_CRL_match:= LoadFuncCLibCrypto('X509_CRL_match');
    @X509_NAME_print:= LoadFuncCLibCrypto('X509_NAME_print');
    @X509_NAME_print_ex:= LoadFuncCLibCrypto('X509_NAME_print_ex');
    @X509_print_ex:= LoadFuncCLibCrypto('X509_print_ex');
    @X509_print:= LoadFuncCLibCrypto('X509_print');
    @X509_ocspid_print:= LoadFuncCLibCrypto('X509_ocspid_print');
    @X509_CERT_AUX_print:= LoadFuncCLibCrypto('X509_CERT_AUX_print');
    @X509_CRL_print:= LoadFuncCLibCrypto('X509_CRL_print');
    @X509_REQ_print_ex:= LoadFuncCLibCrypto('X509_REQ_print_ex');
    @X509_REQ_print:= LoadFuncCLibCrypto('X509_REQ_print');
    @X509_NAME_entry_count:= LoadFuncCLibCrypto('X509_NAME_entry_count');
    @X509_NAME_get_text_by_NID:= LoadFuncCLibCrypto('X509_NAME_get_text_by_NID');
    @X509_NAME_get_text_by_OBJ:= LoadFuncCLibCrypto('X509_NAME_get_text_by_OBJ');
    @X509_NAME_get_index_by_NID:= LoadFuncCLibCrypto('X509_NAME_get_index_by_NID');
    @X509_NAME_get_index_by_OBJ:= LoadFuncCLibCrypto('X509_NAME_get_index_by_OBJ');
    @X509_NAME_get_entry:= LoadFuncCLibCrypto('X509_NAME_get_entry');
    @X509_NAME_delete_entry:= LoadFuncCLibCrypto('X509_NAME_delete_entry');
    @X509_NAME_add_entry:= LoadFuncCLibCrypto('X509_NAME_add_entry');
    @X509_NAME_add_entry_by_OBJ:= LoadFuncCLibCrypto('X509_NAME_add_entry_by_OBJ');
    @X509_NAME_add_entry_by_NID:= LoadFuncCLibCrypto('X509_NAME_add_entry_by_NID');
    @X509_NAME_ENTRY_create_by_txt:= LoadFuncCLibCrypto('X509_NAME_ENTRY_create_by_txt');
    @X509_NAME_ENTRY_create_by_NID:= LoadFuncCLibCrypto('X509_NAME_ENTRY_create_by_NID');
    @X509_NAME_add_entry_by_txt:= LoadFuncCLibCrypto('X509_NAME_add_entry_by_txt');
    @X509_NAME_ENTRY_create_by_OBJ:= LoadFuncCLibCrypto('X509_NAME_ENTRY_create_by_OBJ');
    @X509_NAME_ENTRY_set_object:= LoadFuncCLibCrypto('X509_NAME_ENTRY_set_object');
    @X509_NAME_ENTRY_set_data:= LoadFuncCLibCrypto('X509_NAME_ENTRY_set_data');
    @X509_NAME_ENTRY_get_object:= LoadFuncCLibCrypto('X509_NAME_ENTRY_get_object');
    @X509_NAME_ENTRY_get_data:= LoadFuncCLibCrypto('X509_NAME_ENTRY_get_data');
    @X509v3_get_ext_count:= LoadFuncCLibCrypto('X509v3_get_ext_count');
    @X509v3_get_ext_by_NID:= LoadFuncCLibCrypto('X509v3_get_ext_by_NID');
    @X509v3_get_ext_by_OBJ:= LoadFuncCLibCrypto('X509v3_get_ext_by_OBJ');
    @X509v3_get_ext_by_critical:= LoadFuncCLibCrypto('X509v3_get_ext_by_critical');
    @X509v3_get_ext:= LoadFuncCLibCrypto('X509v3_get_ext');
    @X509v3_delete_ext:= LoadFuncCLibCrypto('X509v3_delete_ext');
    @X509v3_add_ext:= LoadFuncCLibCrypto('X509v3_add_ext');
    @X509_get_ext_count:= LoadFuncCLibCrypto('X509_get_ext_count');
    @X509_get_ext_by_NID:= LoadFuncCLibCrypto('X509_get_ext_by_NID');
    @X509_get_ext_by_OBJ:= LoadFuncCLibCrypto('X509_get_ext_by_OBJ');
    @X509_get_ext_by_critical:= LoadFuncCLibCrypto('X509_get_ext_by_critical');
    @X509_get_ext:= LoadFuncCLibCrypto('X509_get_ext');
    @X509_delete_ext:= LoadFuncCLibCrypto('X509_delete_ext');
    @X509_add_ext:= LoadFuncCLibCrypto('X509_add_ext');
    @X509_get_ext_d2i:= LoadFuncCLibCrypto('X509_get_ext_d2i');
    @X509_add1_ext_i2d:= LoadFuncCLibCrypto('X509_add1_ext_i2d');
    @X509_CRL_get_ext_count:= LoadFuncCLibCrypto('X509_CRL_get_ext_count');
    @X509_CRL_get_ext_by_NID:= LoadFuncCLibCrypto('X509_CRL_get_ext_by_NID');
    @X509_CRL_get_ext_by_OBJ:= LoadFuncCLibCrypto('X509_CRL_get_ext_by_OBJ');
    @X509_CRL_get_ext_by_critical:= LoadFuncCLibCrypto('X509_CRL_get_ext_by_critical');
    @X509_CRL_get_ext:= LoadFuncCLibCrypto('X509_CRL_get_ext');
    @X509_CRL_delete_ext:= LoadFuncCLibCrypto('X509_CRL_delete_ext');
    @X509_CRL_add_ext:= LoadFuncCLibCrypto('X509_CRL_add_ext');
    @X509_CRL_get_ext_d2i:= LoadFuncCLibCrypto('X509_CRL_get_ext_d2i');
    @X509_CRL_add1_ext_i2d:= LoadFuncCLibCrypto('X509_CRL_add1_ext_i2d');
    @X509_REVOKED_get_ext_count:= LoadFuncCLibCrypto('X509_REVOKED_get_ext_count');
    @X509_REVOKED_get_ext_by_NID:= LoadFuncCLibCrypto('X509_REVOKED_get_ext_by_NID');
    @X509_REVOKED_get_ext_by_OBJ:= LoadFuncCLibCrypto('X509_REVOKED_get_ext_by_OBJ');
    @X509_REVOKED_get_ext_by_critical:= LoadFuncCLibCrypto('X509_REVOKED_get_ext_by_critical');
    @X509_REVOKED_get_ext:= LoadFuncCLibCrypto('X509_REVOKED_get_ext');
    @X509_REVOKED_delete_ext:= LoadFuncCLibCrypto('X509_REVOKED_delete_ext');
    @X509_REVOKED_add_ext:= LoadFuncCLibCrypto('X509_REVOKED_add_ext');
    @X509_REVOKED_get_ext_d2i:= LoadFuncCLibCrypto('X509_REVOKED_get_ext_d2i');
    @X509_REVOKED_add1_ext_i2d:= LoadFuncCLibCrypto('X509_REVOKED_add1_ext_i2d');
    @X509_EXTENSION_create_by_NID:= LoadFuncCLibCrypto('X509_EXTENSION_create_by_NID');
    @X509_EXTENSION_create_by_OBJ:= LoadFuncCLibCrypto('X509_EXTENSION_create_by_OBJ');
    @X509_EXTENSION_set_object:= LoadFuncCLibCrypto('X509_EXTENSION_set_object');
    @X509_EXTENSION_set_critical:= LoadFuncCLibCrypto('X509_EXTENSION_set_critical');
    @X509_EXTENSION_set_data:= LoadFuncCLibCrypto('X509_EXTENSION_set_data');
    @X509_EXTENSION_get_object:= LoadFuncCLibCrypto('X509_EXTENSION_get_object');
    @X509_EXTENSION_get_data:= LoadFuncCLibCrypto('X509_EXTENSION_get_data');
    @X509_EXTENSION_get_critical:= LoadFuncCLibCrypto('X509_EXTENSION_get_critical');
    @X509at_get_attr_count:= LoadFuncCLibCrypto('X509at_get_attr_count');
    @X509at_get_attr_by_NID:= LoadFuncCLibCrypto('X509at_get_attr_by_NID');
    @X509at_get_attr_by_OBJ:= LoadFuncCLibCrypto('X509at_get_attr_by_OBJ');
    @X509at_get_attr:= LoadFuncCLibCrypto('X509at_get_attr');
    @X509at_delete_attr:= LoadFuncCLibCrypto('X509at_delete_attr');
    @X509at_add1_attr:= LoadFuncCLibCrypto('X509at_add1_attr');
    @X509at_add1_attr_by_OBJ:= LoadFuncCLibCrypto('X509at_add1_attr_by_OBJ');
    @X509at_add1_attr_by_NID:= LoadFuncCLibCrypto('X509at_add1_attr_by_NID');
    @X509at_add1_attr_by_txt:= LoadFuncCLibCrypto('X509at_add1_attr_by_txt');
    @X509at_get0_data_by_OBJ:= LoadFuncCLibCrypto('X509at_get0_data_by_OBJ');
    @X509_ATTRIBUTE_create_by_NID:= LoadFuncCLibCrypto('X509_ATTRIBUTE_create_by_NID');
    @X509_ATTRIBUTE_create_by_OBJ:= LoadFuncCLibCrypto('X509_ATTRIBUTE_create_by_OBJ');
    @X509_ATTRIBUTE_create_by_txt:= LoadFuncCLibCrypto('X509_ATTRIBUTE_create_by_txt');
    @X509_ATTRIBUTE_set1_object:= LoadFuncCLibCrypto('X509_ATTRIBUTE_set1_object');
    @X509_ATTRIBUTE_set1_data:= LoadFuncCLibCrypto('X509_ATTRIBUTE_set1_data');
    @X509_ATTRIBUTE_get0_data:= LoadFuncCLibCrypto('X509_ATTRIBUTE_get0_data');
    @X509_ATTRIBUTE_count:= LoadFuncCLibCrypto('X509_ATTRIBUTE_count');
    @X509_ATTRIBUTE_get0_object:= LoadFuncCLibCrypto('X509_ATTRIBUTE_get0_object');
    @X509_ATTRIBUTE_get0_type:= LoadFuncCLibCrypto('X509_ATTRIBUTE_get0_type');
    @EVP_PKEY_get_attr_count:= LoadFuncCLibCrypto('EVP_PKEY_get_attr_count');
    @EVP_PKEY_get_attr_by_NID:= LoadFuncCLibCrypto('EVP_PKEY_get_attr_by_NID');
    @EVP_PKEY_get_attr_by_OBJ:= LoadFuncCLibCrypto('EVP_PKEY_get_attr_by_OBJ');
    @EVP_PKEY_get_attr:= LoadFuncCLibCrypto('EVP_PKEY_get_attr');
    @EVP_PKEY_delete_attr:= LoadFuncCLibCrypto('EVP_PKEY_delete_attr');
    @EVP_PKEY_add1_attr:= LoadFuncCLibCrypto('EVP_PKEY_add1_attr');
    @EVP_PKEY_add1_attr_by_OBJ:= LoadFuncCLibCrypto('EVP_PKEY_add1_attr_by_OBJ');
    @EVP_PKEY_add1_attr_by_NID:= LoadFuncCLibCrypto('EVP_PKEY_add1_attr_by_NID');
    @EVP_PKEY_add1_attr_by_txt:= LoadFuncCLibCrypto('EVP_PKEY_add1_attr_by_txt');
    @X509_verify_cert:= LoadFuncCLibCrypto('X509_verify_cert');
    @X509_find_by_issuer_and_serial:= LoadFuncCLibCrypto('X509_find_by_issuer_and_serial');
    @X509_find_by_subject:= LoadFuncCLibCrypto('X509_find_by_subject');
    @PKCS5_pbe_set0_algor:= LoadFuncCLibCrypto('PKCS5_pbe_set0_algor');
    @PKCS5_pbe_set:= LoadFuncCLibCrypto('PKCS5_pbe_set');
    @PKCS5_pbe2_set:= LoadFuncCLibCrypto('PKCS5_pbe2_set');
    @PKCS5_pbe2_set_iv:= LoadFuncCLibCrypto('PKCS5_pbe2_set_iv');
    @PKCS5_pbkdf2_set:= LoadFuncCLibCrypto('PKCS5_pbkdf2_set');
    @EVP_PKCS82PKEY:= LoadFuncCLibCrypto('EVP_PKCS82PKEY');
    @EVP_PKEY2PKCS8:= LoadFuncCLibCrypto('EVP_PKEY2PKCS8');
    @EVP_PKEY2PKCS8_broken:= LoadFuncCLibCrypto('EVP_PKEY2PKCS8_broken');
    @PKCS8_set_broken:= LoadFuncCLibCrypto('PKCS8_set_broken');
    @PKCS8_pkey_set0:= LoadFuncCLibCrypto('PKCS8_pkey_set0');
    @PKCS8_pkey_get0:= LoadFuncCLibCrypto('PKCS8_pkey_get0');
    @X509_PUBKEY_set0_param:= LoadFuncCLibCrypto('X509_PUBKEY_set0_param');
    @X509_PUBKEY_get0_param:= LoadFuncCLibCrypto('X509_PUBKEY_get0_param');
    @X509_check_trust:= LoadFuncCLibCrypto('X509_check_trust');
    @X509_TRUST_get_count:= LoadFuncCLibCrypto('X509_TRUST_get_count');
    @X509_TRUST_get0:= LoadFuncCLibCrypto('X509_TRUST_get0');
    @X509_TRUST_get_by_id:= LoadFuncCLibCrypto('X509_TRUST_get_by_id');
    @X509_TRUST_cleanup:= LoadFuncCLibCrypto('X509_TRUST_cleanup');
    @X509_TRUST_get_flags:= LoadFuncCLibCrypto('X509_TRUST_get_flags');
    @X509_TRUST_get0_name:= LoadFuncCLibCrypto('X509_TRUST_get0_name');
    @X509_TRUST_get_trust:= LoadFuncCLibCrypto('X509_TRUST_get_trust');

    @X509_EXTENSION_new:= LoadFuncCLibCrypto('X509_EXTENSION_new');
    @d2i_X509_EXTENSION:= LoadFuncCLibCrypto('d2i_X509_EXTENSION');
    @i2d_X509_EXTENSION:= LoadFuncCLibCrypto('i2d_X509_EXTENSION');
    @X509_EXTENSION_it:= LoadFuncCLibCrypto('X509_EXTENSION_it');
    @X509_ATTRIBUTE_new:= LoadFuncCLibCrypto('X509_ATTRIBUTE_new');
    @X509_ATTRIBUTE_free:= LoadFuncCLibCrypto('X509_ATTRIBUTE_free');
    @d2i_X509_ATTRIBUTE:= LoadFuncCLibCrypto('d2i_X509_ATTRIBUTE');
    @i2d_X509_ATTRIBUTE:= LoadFuncCLibCrypto('i2d_X509_ATTRIBUTE');
    @X509_ATTRIBUTE_it:= LoadFuncCLibCrypto('X509_ATTRIBUTE_it');
    @d2i_X509_REQ:= LoadFuncCLibCrypto('d2i_X509_REQ');
    @i2d_X509_REQ:= LoadFuncCLibCrypto('i2d_X509_REQ');
    @X509_REQ_it:= LoadFuncCLibCrypto('X509_REQ_it');
    @X509_REQ_INFO_new:= LoadFuncCLibCrypto('X509_REQ_INFO_new');
    @X509_REQ_INFO_free:= LoadFuncCLibCrypto('X509_REQ_INFO_free');
    @d2i_X509_REQ_INFO:= LoadFuncCLibCrypto('d2i_X509_REQ_INFO');
    @i2d_X509_REQ_INFO:= LoadFuncCLibCrypto('i2d_X509_REQ_INFO');
    @X509_REQ_INFO_it:= LoadFuncCLibCrypto('X509_REQ_INFO_it');
    @X509_SIG_new:= LoadFuncCLibCrypto('X509_SIG_new');
    @X509_SIG_free:= LoadFuncCLibCrypto('X509_SIG_free');
    @d2i_X509_SIG:= LoadFuncCLibCrypto('d2i_X509_SIG');
    @i2d_X509_SIG:= LoadFuncCLibCrypto('i2d_X509_SIG');
    @X509_SIG_it:= LoadFuncCLibCrypto('X509_SIG_it');
    @X509_PUBKEY_new:= LoadFuncCLibCrypto('X509_PUBKEY_new');
    @X509_PUBKEY_free:= LoadFuncCLibCrypto('X509_PUBKEY_free');
    @d2i_X509_PUBKEY:= LoadFuncCLibCrypto('d2i_X509_PUBKEY');
    @i2d_X509_PUBKEY:= LoadFuncCLibCrypto('i2d_X509_PUBKEY');
    @X509_PUBKEY_it:= LoadFuncCLibCrypto('X509_PUBKEY_it');
    @X509_VAL_new:= LoadFuncCLibCrypto('X509_VAL_new');
    @X509_VAL_free:= LoadFuncCLibCrypto('X509_VAL_free');
    @d2i_X509_VAL:= LoadFuncCLibCrypto('d2i_X509_VAL');
    @i2d_X509_VAL:= LoadFuncCLibCrypto('i2d_X509_VAL');
    @X509_VAL_it:= LoadFuncCLibCrypto('X509_VAL_it');
    @X509_NAME_ENTRY_new:= LoadFuncCLibCrypto('X509_NAME_ENTRY_new');
    @X509_NAME_ENTRY_free:= LoadFuncCLibCrypto('X509_NAME_ENTRY_free');
    @d2i_X509_NAME_ENTRY:= LoadFuncCLibCrypto('d2i_X509_NAME_ENTRY');
    @i2d_X509_NAME_ENTRY:= LoadFuncCLibCrypto('i2d_X509_NAME_ENTRY');
    @X509_NAME_ENTRY_it:= LoadFuncCLibCrypto('X509_NAME_ENTRY_it');
    @d2i_X509_NAME:= LoadFuncCLibCrypto('d2i_X509_NAME');
    @i2d_X509_NAME:= LoadFuncCLibCrypto('i2d_X509_NAME');
    @X509_NAME_it:= LoadFuncCLibCrypto('X509_NAME_it');
    @X509_CINF_new:= LoadFuncCLibCrypto('X509_CINF_new');
    @X509_CINF_free:= LoadFuncCLibCrypto('X509_CINF_free');
    @d2i_X509_CINF:= LoadFuncCLibCrypto('d2i_X509_CINF');
    @i2d_X509_CINF:= LoadFuncCLibCrypto('i2d_X509_CINF');
    @X509_CINF_it:= LoadFuncCLibCrypto('X509_CINF_it');
    @d2i_X509:= LoadFuncCLibCrypto('d2i_X509');
    @i2d_X509:= LoadFuncCLibCrypto('i2d_X509');
    @X509_it:= LoadFuncCLibCrypto('X509_it');
    @X509_CERT_AUX_new:= LoadFuncCLibCrypto('X509_CERT_AUX_new');
    @X509_CERT_AUX_free:= LoadFuncCLibCrypto('X509_CERT_AUX_free');
    @d2i_X509_CERT_AUX:= LoadFuncCLibCrypto('d2i_X509_CERT_AUX');
    @i2d_X509_CERT_AUX:= LoadFuncCLibCrypto('i2d_X509_CERT_AUX');
    @X509_CERT_AUX_it:= LoadFuncCLibCrypto('X509_CERT_AUX_it');
    @X509_CERT_PAIR_new:= LoadFuncCLibCrypto('X509_CERT_PAIR_new');
    @X509_CERT_PAIR_free:= LoadFuncCLibCrypto('X509_CERT_PAIR_free');
    @d2i_X509_CERT_PAIR:= LoadFuncCLibCrypto('d2i_X509_CERT_PAIR');
    @i2d_X509_CERT_PAIR:= LoadFuncCLibCrypto('i2d_X509_CERT_PAIR');
    @X509_CERT_PAIR_it:= LoadFuncCLibCrypto('X509_CERT_PAIR_it');
    @X509_REVOKED_new:= LoadFuncCLibCrypto('X509_REVOKED_new');
    @X509_REVOKED_free:= LoadFuncCLibCrypto('X509_REVOKED_free');
    @d2i_X509_REVOKED:= LoadFuncCLibCrypto('d2i_X509_REVOKED');
    @i2d_X509_REVOKED:= LoadFuncCLibCrypto('i2d_X509_REVOKED');
    @X509_REVOKED_it:= LoadFuncCLibCrypto('X509_REVOKED_it');
    @X509_CRL_INFO_new:= LoadFuncCLibCrypto('X509_CRL_INFO_new');
    @X509_CRL_INFO_free:= LoadFuncCLibCrypto('X509_CRL_INFO_free');
    @d2i_X509_CRL_INFO:= LoadFuncCLibCrypto('d2i_X509_CRL_INFO');
    @i2d_X509_CRL_INFO:= LoadFuncCLibCrypto('i2d_X509_CRL_INFO');
    @X509_CRL_INFO_it:= LoadFuncCLibCrypto('X509_CRL_INFO_it');
    @X509_CRL_new:= LoadFuncCLibCrypto('X509_CRL_new');
    @X509_CRL_free:= LoadFuncCLibCrypto('X509_CRL_free');
    @d2i_X509_CRL:= LoadFuncCLibCrypto('d2i_X509_CRL');
    @i2d_X509_CRL:= LoadFuncCLibCrypto('i2d_X509_CRL');
    @X509_CRL_it:= LoadFuncCLibCrypto('X509_CRL_it');
    @NETSCAPE_SPKI_new:= LoadFuncCLibCrypto('NETSCAPE_SPKI_new');
    @NETSCAPE_SPKI_free:= LoadFuncCLibCrypto('NETSCAPE_SPKI_free');
    @d2i_NETSCAPE_SPKI:= LoadFuncCLibCrypto('d2i_NETSCAPE_SPKI');
    @i2d_NETSCAPE_SPKI:= LoadFuncCLibCrypto('i2d_NETSCAPE_SPKI');
    @NETSCAPE_SPKI_it:= LoadFuncCLibCrypto('NETSCAPE_SPKI_it');
    @NETSCAPE_SPKAC_new:= LoadFuncCLibCrypto('NETSCAPE_SPKAC_new');
    @NETSCAPE_SPKAC_free:= LoadFuncCLibCrypto('NETSCAPE_SPKAC_free');
    @d2i_NETSCAPE_SPKAC:= LoadFuncCLibCrypto('d2i_NETSCAPE_SPKAC');
    @i2d_NETSCAPE_SPKAC:= LoadFuncCLibCrypto('i2d_NETSCAPE_SPKAC');
    @NETSCAPE_SPKAC_it:= LoadFuncCLibCrypto('NETSCAPE_SPKAC_it');
    @NETSCAPE_CERT_SEQUENCE_new:= LoadFuncCLibCrypto('NETSCAPE_CERT_SEQUENCE_new');
    @NETSCAPE_CERT_SEQUENCE_free:= LoadFuncCLibCrypto('NETSCAPE_CERT_SEQUENCE_free');
    @d2i_NETSCAPE_CERT_SEQUENCE:= LoadFuncCLibCrypto('d2i_NETSCAPE_CERT_SEQUENCE');
    @i2d_NETSCAPE_CERT_SEQUENCE:= LoadFuncCLibCrypto('i2d_NETSCAPE_CERT_SEQUENCE');
    @NETSCAPE_CERT_SEQUENCE_it:= LoadFuncCLibCrypto('NETSCAPE_CERT_SEQUENCE_it');

    @PROXY_POLICY_new:= LoadFuncCLibCrypto('PROXY_POLICY_new');
    @PROXY_POLICY_free:= LoadFuncCLibCrypto('PROXY_POLICY_free');
    @d2i_PROXY_POLICY:= LoadFuncCLibCrypto('d2i_PROXY_POLICY');
    @i2d_PROXY_POLICY:= LoadFuncCLibCrypto('i2d_PROXY_POLICY');
    @PROXY_POLICY_it:= LoadFuncCLibCrypto('PROXY_POLICY_it');
    @PROXY_CERT_INFO_EXTENSION_new:= LoadFuncCLibCrypto('PROXY_CERT_INFO_EXTENSION_new');
    @PROXY_CERT_INFO_EXTENSION_free:= LoadFuncCLibCrypto('PROXY_CERT_INFO_EXTENSION_free');
    @d2i_PROXY_CERT_INFO_EXTENSION:= LoadFuncCLibCrypto('d2i_PROXY_CERT_INFO_EXTENSION');
    @i2d_PROXY_CERT_INFO_EXTENSION:= LoadFuncCLibCrypto('i2d_PROXY_CERT_INFO_EXTENSION');
    @PROXY_CERT_INFO_EXTENSION_it:= LoadFuncCLibCrypto('PROXY_CERT_INFO_EXTENSION_it');
    @BASIC_CONSTRAINTS_new:= LoadFuncCLibCrypto('BASIC_CONSTRAINTS_new');
    @BASIC_CONSTRAINTS_free:= LoadFuncCLibCrypto('BASIC_CONSTRAINTS_free');
    @d2i_BASIC_CONSTRAINTS:= LoadFuncCLibCrypto('d2i_BASIC_CONSTRAINTS');
    @i2d_BASIC_CONSTRAINTS:= LoadFuncCLibCrypto('i2d_BASIC_CONSTRAINTS');
    @BASIC_CONSTRAINTS_it:= LoadFuncCLibCrypto('BASIC_CONSTRAINTS_it');
    @SXNET_new:= LoadFuncCLibCrypto('SXNET_new');
    @SXNET_free:= LoadFuncCLibCrypto('SXNET_free');
    @d2i_SXNET:= LoadFuncCLibCrypto('d2i_SXNET');
    @i2d_SXNET:= LoadFuncCLibCrypto('i2d_SXNET');
    @SXNET_it:= LoadFuncCLibCrypto('SXNET_it');
    @SXNETID_new:= LoadFuncCLibCrypto('SXNETID_new');
    @SXNETID_free:= LoadFuncCLibCrypto('SXNETID_free');
    @d2i_SXNETID:= LoadFuncCLibCrypto('d2i_SXNETID');
    @i2d_SXNETID:= LoadFuncCLibCrypto('i2d_SXNETID');
    @SXNETID_it:= LoadFuncCLibCrypto('SXNETID_it');
    @AUTHORITY_KEYID_new:= LoadFuncCLibCrypto('AUTHORITY_KEYID_new');
    @AUTHORITY_KEYID_free:= LoadFuncCLibCrypto('AUTHORITY_KEYID_free');
    @d2i_AUTHORITY_KEYID:= LoadFuncCLibCrypto('d2i_AUTHORITY_KEYID');
    @i2d_AUTHORITY_KEYID:= LoadFuncCLibCrypto('i2d_AUTHORITY_KEYID');
    @AUTHORITY_KEYID_it:= LoadFuncCLibCrypto('AUTHORITY_KEYID_it');
    @PKEY_USAGE_PERIOD_new:= LoadFuncCLibCrypto('PKEY_USAGE_PERIOD_new');
    @PKEY_USAGE_PERIOD_free:= LoadFuncCLibCrypto('PKEY_USAGE_PERIOD_free');
    @d2i_PKEY_USAGE_PERIOD:= LoadFuncCLibCrypto('d2i_PKEY_USAGE_PERIOD');
    @i2d_PKEY_USAGE_PERIOD:= LoadFuncCLibCrypto('i2d_PKEY_USAGE_PERIOD');
    @PKEY_USAGE_PERIOD_it:= LoadFuncCLibCrypto('PKEY_USAGE_PERIOD_it');
    @GENERAL_NAME_new:= LoadFuncCLibCrypto('GENERAL_NAME_new');
    @GENERAL_NAME_free:= LoadFuncCLibCrypto('GENERAL_NAME_free');
    @d2i_GENERAL_NAME:= LoadFuncCLibCrypto('d2i_GENERAL_NAME');
    @i2d_GENERAL_NAME:= LoadFuncCLibCrypto('i2d_GENERAL_NAME');
    @GENERAL_NAME_it:= LoadFuncCLibCrypto('GENERAL_NAME_it');
    @GENERAL_NAMES_new:= LoadFuncCLibCrypto('GENERAL_NAMES_new');
    @GENERAL_NAMES_free:= LoadFuncCLibCrypto('GENERAL_NAMES_free');
    @d2i_GENERAL_NAMES:= LoadFuncCLibCrypto('d2i_GENERAL_NAMES');
    @i2d_GENERAL_NAMES:= LoadFuncCLibCrypto('i2d_GENERAL_NAMES');
    @GENERAL_NAMES_it:= LoadFuncCLibCrypto('GENERAL_NAMES_it');
    @OTHERNAME_new:= LoadFuncCLibCrypto('OTHERNAME_new');
    @OTHERNAME_free:= LoadFuncCLibCrypto('OTHERNAME_free');
    @d2i_OTHERNAME:= LoadFuncCLibCrypto('d2i_OTHERNAME');
    @i2d_OTHERNAME:= LoadFuncCLibCrypto('i2d_OTHERNAME');
    @OTHERNAME_it:= LoadFuncCLibCrypto('OTHERNAME_it');
    @EDIPARTYNAME_new:= LoadFuncCLibCrypto('EDIPARTYNAME_new');
    @EDIPARTYNAME_free:= LoadFuncCLibCrypto('EDIPARTYNAME_free');
    @d2i_EDIPARTYNAME:= LoadFuncCLibCrypto('d2i_EDIPARTYNAME');
    @i2d_EDIPARTYNAME:= LoadFuncCLibCrypto('i2d_EDIPARTYNAME');
    @EDIPARTYNAME_it:= LoadFuncCLibCrypto('EDIPARTYNAME_it');
    @EXTENDED_KEY_USAGE_new:= LoadFuncCLibCrypto('EXTENDED_KEY_USAGE_new');
    @EXTENDED_KEY_USAGE_free:= LoadFuncCLibCrypto('EXTENDED_KEY_USAGE_free');
    @d2i_EXTENDED_KEY_USAGE:= LoadFuncCLibCrypto('d2i_EXTENDED_KEY_USAGE');
    @i2d_EXTENDED_KEY_USAGE:= LoadFuncCLibCrypto('i2d_EXTENDED_KEY_USAGE');
    @EXTENDED_KEY_USAGE_it:= LoadFuncCLibCrypto('EXTENDED_KEY_USAGE_it');
    @CERTIFICATEPOLICIES_new:= LoadFuncCLibCrypto('CERTIFICATEPOLICIES_new');
    @CERTIFICATEPOLICIES_free:= LoadFuncCLibCrypto('CERTIFICATEPOLICIES_free');
    @d2i_CERTIFICATEPOLICIES:= LoadFuncCLibCrypto('d2i_CERTIFICATEPOLICIES');
    @i2d_CERTIFICATEPOLICIES:= LoadFuncCLibCrypto('i2d_CERTIFICATEPOLICIES');
    @CERTIFICATEPOLICIES_it:= LoadFuncCLibCrypto('CERTIFICATEPOLICIES_it');
    @POLICYINFO_new:= LoadFuncCLibCrypto('POLICYINFO_new');
    @POLICYINFO_free:= LoadFuncCLibCrypto('POLICYINFO_free');
    @d2i_POLICYINFO:= LoadFuncCLibCrypto('d2i_POLICYINFO');
    @i2d_POLICYINFO:= LoadFuncCLibCrypto('i2d_POLICYINFO');
    @POLICYINFO_it:= LoadFuncCLibCrypto('POLICYINFO_it');
    @POLICYQUALINFO_new:= LoadFuncCLibCrypto('POLICYQUALINFO_new');
    @POLICYQUALINFO_free:= LoadFuncCLibCrypto('POLICYQUALINFO_free');
    @d2i_POLICYQUALINFO:= LoadFuncCLibCrypto('d2i_POLICYQUALINFO');
    @i2d_POLICYQUALINFO:= LoadFuncCLibCrypto('i2d_POLICYQUALINFO');
    @POLICYQUALINFO_it:= LoadFuncCLibCrypto('POLICYQUALINFO_it');
    @USERNOTICE_new:= LoadFuncCLibCrypto('USERNOTICE_new');
    @USERNOTICE_free:= LoadFuncCLibCrypto('USERNOTICE_free');
    @d2i_USERNOTICE:= LoadFuncCLibCrypto('d2i_USERNOTICE');
    @i2d_USERNOTICE:= LoadFuncCLibCrypto('i2d_USERNOTICE');
    @USERNOTICE_it:= LoadFuncCLibCrypto('USERNOTICE_it');
    @NOTICEREF_new:= LoadFuncCLibCrypto('NOTICEREF_new');
    @NOTICEREF_free:= LoadFuncCLibCrypto('NOTICEREF_free');
    @d2i_NOTICEREF:= LoadFuncCLibCrypto('d2i_NOTICEREF');
    @i2d_NOTICEREF:= LoadFuncCLibCrypto('i2d_NOTICEREF');
    @NOTICEREF_it:= LoadFuncCLibCrypto('NOTICEREF_it');
    @CRL_DIST_POINTS_new:= LoadFuncCLibCrypto('CRL_DIST_POINTS_new');
    @CRL_DIST_POINTS_free:= LoadFuncCLibCrypto('CRL_DIST_POINTS_free');
    @d2i_CRL_DIST_POINTS:= LoadFuncCLibCrypto('d2i_CRL_DIST_POINTS');
    @i2d_CRL_DIST_POINTS:= LoadFuncCLibCrypto('i2d_CRL_DIST_POINTS');
    @CRL_DIST_POINTS_it:= LoadFuncCLibCrypto('CRL_DIST_POINTS_it');
    @DIST_POINT_new:= LoadFuncCLibCrypto('DIST_POINT_new');
    @DIST_POINT_free:= LoadFuncCLibCrypto('DIST_POINT_free');
    @d2i_DIST_POINT:= LoadFuncCLibCrypto('d2i_DIST_POINT');
    @i2d_DIST_POINT:= LoadFuncCLibCrypto('i2d_DIST_POINT');
    @DIST_POINT_it:= LoadFuncCLibCrypto('DIST_POINT_it');
    @DIST_POINT_NAME_new:= LoadFuncCLibCrypto('DIST_POINT_NAME_new');
    @DIST_POINT_NAME_free:= LoadFuncCLibCrypto('DIST_POINT_NAME_free');
    @d2i_DIST_POINT_NAME:= LoadFuncCLibCrypto('d2i_DIST_POINT_NAME');
    @i2d_DIST_POINT_NAME:= LoadFuncCLibCrypto('i2d_DIST_POINT_NAME');
    @DIST_POINT_NAME_it:= LoadFuncCLibCrypto('DIST_POINT_NAME_it');
    @ISSUING_DIST_POINT_new:= LoadFuncCLibCrypto('ISSUING_DIST_POINT_new');
    @ISSUING_DIST_POINT_free:= LoadFuncCLibCrypto('ISSUING_DIST_POINT_free');
    @d2i_ISSUING_DIST_POINT:= LoadFuncCLibCrypto('d2i_ISSUING_DIST_POINT');
    @i2d_ISSUING_DIST_POINT:= LoadFuncCLibCrypto('i2d_ISSUING_DIST_POINT');
    @ISSUING_DIST_POINT_it:= LoadFuncCLibCrypto('ISSUING_DIST_POINT_it');
    @ACCESS_DESCRIPTION_new:= LoadFuncCLibCrypto('ACCESS_DESCRIPTION_new');
    @ACCESS_DESCRIPTION_free:= LoadFuncCLibCrypto('ACCESS_DESCRIPTION_free');
    @d2i_ACCESS_DESCRIPTION:= LoadFuncCLibCrypto('d2i_ACCESS_DESCRIPTION');
    @i2d_ACCESS_DESCRIPTION:= LoadFuncCLibCrypto('i2d_ACCESS_DESCRIPTION');
    @ACCESS_DESCRIPTION_it:= LoadFuncCLibCrypto('ACCESS_DESCRIPTION_it');
    @AUTHORITY_INFO_ACCESS_new:= LoadFuncCLibCrypto('AUTHORITY_INFO_ACCESS_new');
    @AUTHORITY_INFO_ACCESS_free:= LoadFuncCLibCrypto('AUTHORITY_INFO_ACCESS_free');
    @d2i_AUTHORITY_INFO_ACCESS:= LoadFuncCLibCrypto('d2i_AUTHORITY_INFO_ACCESS');
    @i2d_AUTHORITY_INFO_ACCESS:= LoadFuncCLibCrypto('i2d_AUTHORITY_INFO_ACCESS');
    @AUTHORITY_INFO_ACCESS_it:= LoadFuncCLibCrypto('AUTHORITY_INFO_ACCESS_it');
    
    @SXNET_add_id_asc:= LoadFuncCLibCrypto('SXNET_add_id_asc');
    @SXNET_add_id_ulong:= LoadFuncCLibCrypto('SXNET_add_id_ulong');
    @SXNET_add_id_INTEGER:= LoadFuncCLibCrypto('SXNET_add_id_INTEGER');
    @SXNET_get_id_asc:= LoadFuncCLibCrypto('SXNET_get_id_asc');
    @SXNET_get_id_ulong:= LoadFuncCLibCrypto('SXNET_get_id_ulong');
    @SXNET_get_id_INTEGER:= LoadFuncCLibCrypto('SXNET_get_id_INTEGER');
    @GENERAL_NAME_cmp:= LoadFuncCLibCrypto('GENERAL_NAME_cmp');
    @v2i_ASN1_BIT_STRING:= LoadFuncCLibCrypto('v2i_ASN1_BIT_STRING');
    @i2v_ASN1_BIT_STRING:= LoadFuncCLibCrypto('i2v_ASN1_BIT_STRING');
    @i2v_GENERAL_NAME:= LoadFuncCLibCrypto('i2v_GENERAL_NAME');
    @GENERAL_NAME_print:= LoadFuncCLibCrypto('GENERAL_NAME_print');
    @i2v_GENERAL_NAMES:= LoadFuncCLibCrypto('i2v_GENERAL_NAMES');
    @v2i_GENERAL_NAMES:= LoadFuncCLibCrypto('v2i_GENERAL_NAMES');
    @OTHERNAME_cmp:= LoadFuncCLibCrypto('OTHERNAME_cmp');
    @GENERAL_NAME_set0_value:= LoadFuncCLibCrypto('GENERAL_NAME_set0_value');
    @GENERAL_NAME_get0_value:= LoadFuncCLibCrypto('GENERAL_NAME_get0_value');
    @GENERAL_NAME_set0_othername:= LoadFuncCLibCrypto('GENERAL_NAME_set0_othername');
    @GENERAL_NAME_get0_otherName:= LoadFuncCLibCrypto('GENERAL_NAME_get0_otherName');
    @i2s_ASN1_OCTET_STRING:= LoadFuncCLibCrypto('i2s_ASN1_OCTET_STRING');
    @s2i_ASN1_OCTET_STRING:= LoadFuncCLibCrypto('s2i_ASN1_OCTET_STRING');
    @i2a_ACCESS_DESCRIPTION:= LoadFuncCLibCrypto('i2a_ACCESS_DESCRIPTION');
    @DIST_POINT_set_dpname:= LoadFuncCLibCrypto('DIST_POINT_set_dpname');
    @NAME_CONSTRAINTS_check:= LoadFuncCLibCrypto('NAME_CONSTRAINTS_check');
    @a2i_GENERAL_NAME:= LoadFuncCLibCrypto('a2i_GENERAL_NAME');
    @v2i_GENERAL_NAME:= LoadFuncCLibCrypto('v2i_GENERAL_NAME');
    @v2i_GENERAL_NAME_ex:= LoadFuncCLibCrypto('v2i_GENERAL_NAME_ex');
    @X509V3_conf_free:= LoadFuncCLibCrypto('X509V3_conf_free');
    @X509V3_EXT_nconf_nid:= LoadFuncCLibCrypto('X509V3_EXT_nconf_nid');
    @X509V3_EXT_nconf:= LoadFuncCLibCrypto('X509V3_EXT_nconf');
    @X509V3_EXT_add_nconf_sk:= LoadFuncCLibCrypto('X509V3_EXT_add_nconf_sk');
    @X509V3_EXT_add_nconf:= LoadFuncCLibCrypto('X509V3_EXT_add_nconf');
    @X509V3_EXT_REQ_add_nconf:= LoadFuncCLibCrypto('X509V3_EXT_REQ_add_nconf');
    @X509V3_EXT_CRL_add_nconf:= LoadFuncCLibCrypto('X509V3_EXT_CRL_add_nconf');
    @X509V3_EXT_conf:= LoadFuncCLibCrypto('X509V3_EXT_conf');
    @X509V3_EXT_add_conf:= LoadFuncCLibCrypto('X509V3_EXT_add_conf');
    @X509V3_EXT_REQ_add_conf:= LoadFuncCLibCrypto('X509V3_EXT_REQ_add_conf');
    @X509V3_EXT_CRL_add_conf:= LoadFuncCLibCrypto('X509V3_EXT_CRL_add_conf');
    @X509V3_add_value_bool_nf:= LoadFuncCLibCrypto('X509V3_add_value_bool_nf');
    @X509V3_get_value_bool:= LoadFuncCLibCrypto('X509V3_get_value_bool');
    @X509V3_get_value_int:= LoadFuncCLibCrypto('X509V3_get_value_int');
    @X509V3_set_nconf:= LoadFuncCLibCrypto('X509V3_set_nconf');
    @X509V3_set_conf_lhash:= LoadFuncCLibCrypto('X509V3_set_conf_lhash');
     
    @X509V3_get_string:= LoadFuncCLibCrypto('X509V3_get_string');
    @X509V3_get_section:= LoadFuncCLibCrypto('X509V3_get_section');
    @X509V3_string_free:= LoadFuncCLibCrypto('X509V3_string_free');
    @X509V3_section_free:= LoadFuncCLibCrypto('X509V3_section_free');
    
    @X509V3_add_value:= LoadFuncCLibCrypto('X509V3_add_value');
    @X509V3_add_value_uchar:= LoadFuncCLibCrypto('X509V3_add_value_uchar');
    @X509V3_add_value_bool:= LoadFuncCLibCrypto('X509V3_add_value_bool');
    @X509V3_add_value_int:= LoadFuncCLibCrypto('X509V3_add_value_int');
    @i2s_ASN1_INTEGER:= LoadFuncCLibCrypto('i2s_ASN1_INTEGER');
    @s2i_ASN1_INTEGER:= LoadFuncCLibCrypto('s2i_ASN1_INTEGER');
    @i2s_ASN1_ENUMERATED:= LoadFuncCLibCrypto('i2s_ASN1_ENUMERATED');
    @i2s_ASN1_ENUMERATED_TABLE:= LoadFuncCLibCrypto('i2s_ASN1_ENUMERATED_TABLE');
    @X509V3_EXT_add:= LoadFuncCLibCrypto('X509V3_EXT_add');
    @X509V3_EXT_add_list:= LoadFuncCLibCrypto('X509V3_EXT_add_list');
    @X509V3_EXT_add_alias:= LoadFuncCLibCrypto('X509V3_EXT_add_alias');
    @X509V3_EXT_cleanup:= LoadFuncCLibCrypto('X509V3_EXT_cleanup');
    
   @X509V3_EXT_get:= LoadFuncCLibCrypto('X509V3_EXT_get');
   @X509V3_EXT_get_nid:= LoadFuncCLibCrypto('X509V3_EXT_get_nid');
   @X509V3_add_standard_extensions:= LoadFuncCLibCrypto('X509V3_add_standard_extensions');
   @X509V3_parse_list:= LoadFuncCLibCrypto('X509V3_parse_list');
   @X509V3_EXT_d2i:= LoadFuncCLibCrypto('X509V3_EXT_d2i');
   @X509V3_get_d2i:= LoadFuncCLibCrypto('X509V3_get_d2i');
     
   @X509V3_EXT_i2d:= LoadFuncCLibCrypto('X509V3_EXT_i2d');
   @X509V3_add1_i2d:= LoadFuncCLibCrypto('X509V3_add1_i2d');
   @hex_to_string:= LoadFuncCLibCrypto('hex_to_string');
   @string_to_hex:= LoadFuncCLibCrypto('string_to_hex');
   @name_cmp:= LoadFuncCLibCrypto('name_cmp');
   @X509V3_EXT_val_prn:= LoadFuncCLibCrypto('X509V3_EXT_val_prn');
   @X509V3_EXT_print:= LoadFuncCLibCrypto('X509V3_EXT_print');

   @X509V3_extensions_print:= LoadFuncCLibCrypto('X509V3_extensions_print');

   @X509_check_ca:= LoadFuncCLibCrypto('X509_check_ca');
   @X509_check_purpose:= LoadFuncCLibCrypto('X509_check_purpose');
   @X509_supported_extension:= LoadFuncCLibCrypto('X509_supported_extension');
   @X509_PURPOSE_set:= LoadFuncCLibCrypto('X509_PURPOSE_set');
   @X509_check_issued:= LoadFuncCLibCrypto('X509_check_issued');
   @X509_check_akid:= LoadFuncCLibCrypto('X509_check_akid');
   @X509_PURPOSE_get_count:= LoadFuncCLibCrypto('X509_PURPOSE_get_count');
   @X509_PURPOSE_get0:= LoadFuncCLibCrypto('X509_PURPOSE_get0');
   @X509_PURPOSE_get_by_sname:= LoadFuncCLibCrypto('X509_PURPOSE_get_by_sname');
   @X509_PURPOSE_get_by_id:= LoadFuncCLibCrypto('X509_PURPOSE_get_by_id');
   @X509_PURPOSE_add:= LoadFuncCLibCrypto('X509_PURPOSE_add');
   @X509_PURPOSE_get0_name:= LoadFuncCLibCrypto('X509_PURPOSE_get0_name');
   @X509_PURPOSE_get0_sname:= LoadFuncCLibCrypto('X509_PURPOSE_get0_sname');
   @X509_PURPOSE_get_trust:= LoadFuncCLibCrypto('X509_PURPOSE_get_trust');
   @X509_PURPOSE_cleanup:= LoadFuncCLibCrypto('X509_PURPOSE_cleanup');
   @X509_PURPOSE_get_id:= LoadFuncCLibCrypto('X509_PURPOSE_get_id');

   @X509_get1_email:= LoadFuncCLibCrypto('X509_get1_email');
   @X509_REQ_get1_email:= LoadFuncCLibCrypto('X509_REQ_get1_email');
   @X509_email_free:= LoadFuncCLibCrypto('X509_email_free');
   @X509_get1_ocsp:= LoadFuncCLibCrypto('X509_get1_ocsp');

   @a2i_IPADDRESS:= LoadFuncCLibCrypto('a2i_IPADDRESS');
   @a2i_IPADDRESS_NC:= LoadFuncCLibCrypto('a2i_IPADDRESS_NC');
   @a2i_ipadd:= LoadFuncCLibCrypto('a2i_ipadd');
   @X509V3_NAME_from_section:= LoadFuncCLibCrypto('X509V3_NAME_from_section');

   @X509_POLICY_NODE_print:= LoadFuncCLibCrypto('X509_POLICY_NODE_print');

   @X509_STORE_new:= LoadFuncCLibCrypto('X509_STORE_new');
   @X509_STORE_free:= LoadFuncCLibCrypto('X509_STORE_free');
   @X509_STORE_add_cert:= LoadFuncCLibCrypto('X509_STORE_add_cert');
   @X509_STORE_add_crl:= LoadFuncCLibCrypto('X509_STORE_add_crl');
