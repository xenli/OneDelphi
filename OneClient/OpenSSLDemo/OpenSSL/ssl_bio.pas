...
begin
  if @BIO_new = nil then
  begin
    @BIO_new := LoadFuncCLibCrypto('BIO_new');
    @BIO_set := LoadFuncCLibCrypto('BIO_set');
    @BIO_free:= LoadFuncCLibCrypto('BIO_free');
    @BIO_vfree:= LoadFuncCLibCrypto('BIO_vfree');
    @BIO_read:= LoadFuncCLibCrypto('BIO_read');
    @BIO_gets:= LoadFuncCLibCrypto('BIO_gets');
    @BIO_write:= LoadFuncCLibCrypto('BIO_write');
    @BIO_puts:= LoadFuncCLibCrypto('BIO_puts');
    @BIO_indent:= LoadFuncCLibCrypto('BIO_indent');
    @BIO_ctrl:= LoadFuncCLibCrypto('BIO_ctrl');
    @BIO_callback_ctrl:= LoadFuncCLibCrypto('BIO_callback_ctrl');
    @BIO_ptr_ctrl:= LoadFuncCLibCrypto('BIO_ptr_ctrl');
    @BIO_int_ctrl:= LoadFuncCLibCrypto('BIO_int_ctrl');
    @BIO_push:= LoadFuncCLibCrypto('BIO_push');
    @BIO_pop:= LoadFuncCLibCrypto('BIO_pop');
    @BIO_free_all:= LoadFuncCLibCrypto('BIO_free_all');
    @BIO_find_type:= LoadFuncCLibCrypto('BIO_find_type');
    @BIO_next:= LoadFuncCLibCrypto('BIO_next');
    @BIO_get_retry_BIO:= LoadFuncCLibCrypto('BIO_get_retry_BIO');
    @BIO_get_retry_reason:= LoadFuncCLibCrypto('BIO_get_retry_reason');
    @BIO_dup_chain:= LoadFuncCLibCrypto('BIO_dup_chain');
    @BIO_s_mem:= LoadFuncCLibCrypto('BIO_s_mem');
    @BIO_new_mem_buf:= LoadFuncCLibCrypto('BIO_new_mem_buf');
    @BIO_s_socket:= LoadFuncCLibCrypto('BIO_s_socket');
    @BIO_s_file:= LoadFuncCLibCrypto('BIO_s_file');
    @BIO_s_connect:= LoadFuncCLibCrypto('BIO_s_connect');
    @BIO_s_accept:= LoadFuncCLibCrypto('BIO_s_accept');
    @BIO_s_fd:= LoadFuncCLibCrypto('BIO_s_fd');
    @BIO_s_log:= LoadFuncCLibCrypto('BIO_s_log', false);
    @BIO_s_bio:= LoadFuncCLibCrypto('BIO_s_bio');
    @BIO_s_null:= LoadFuncCLibCrypto('BIO_s_null');
    @BIO_f_null:= LoadFuncCLibCrypto('BIO_f_null');
    @BIO_f_buffer:= LoadFuncCLibCrypto('BIO_f_buffer');
    @BIO_f_linebuffer:= LoadFuncCLibCrypto('BIO_f_linebuffer', false);
    @BIO_f_nbio_test:= LoadFuncCLibCrypto('BIO_f_nbio_test');
    @BIO_s_datagram:= LoadFuncCLibCrypto('BIO_s_datagram');
    @BIO_new_socket:= LoadFuncCLibCrypto('BIO_new_socket');
    @BIO_new_dgram:= LoadFuncCLibCrypto('BIO_new_dgram');
    @BIO_sock_error:= LoadFuncCLibCrypto('BIO_sock_error');
    @BIO_socket_ioctl:= LoadFuncCLibCrypto('BIO_socket_ioctl');
    @BIO_socket_nbio:= LoadFuncCLibCrypto('BIO_socket_nbio');
    @BIO_get_port:= LoadFuncCLibCrypto('BIO_get_port');
    @BIO_get_host_ip:= LoadFuncCLibCrypto('BIO_get_host_ip');
    @BIO_get_accept_socket:= LoadFuncCLibCrypto('BIO_get_accept_socket');
    @BIO_accept:= LoadFuncCLibCrypto('BIO_accept');
    @BIO_sock_init:= LoadFuncCLibCrypto('BIO_sock_init');
    @BIO_sock_cleanup:= LoadFuncCLibCrypto('BIO_sock_cleanup');
    @BIO_set_tcp_ndelay:= LoadFuncCLibCrypto('BIO_set_tcp_ndelay');
    @BIO_asn1_set_prefix:= LoadFuncCLibCrypto('BIO_asn1_set_prefix', false);
    @BIO_asn1_get_prefix:= LoadFuncCLibCrypto('BIO_asn1_get_prefix', false);
    @BIO_asn1_set_suffix:= LoadFuncCLibCrypto('BIO_asn1_set_suffix', false);
    @BIO_asn1_get_suffix:= LoadFuncCLibCrypto('BIO_asn1_get_suffix', false);
    @BIO_set_flags:= LoadFuncCLibCrypto('BIO_set_flags');
    @BIO_test_flags:= LoadFuncCLibCrypto('BIO_test_flags');
    @BIO_clear_flags:= LoadFuncCLibCrypto('BIO_clear_flags');
    @BIO_copy_next_retry:= LoadFuncCLibCrypto('BIO_copy_next_retry');
    @BIO_ctrl_get_write_guarantee:= LoadFuncCLibCrypto('BIO_ctrl_get_write_guarantee');
    @BIO_ctrl_get_read_request:= LoadFuncCLibCrypto('BIO_ctrl_get_read_request');
    @BIO_ctrl_reset_read_request:= LoadFuncCLibCrypto('BIO_ctrl_reset_read_request');
    @BIO_ctrl_pending_f:= LoadFuncCLibCrypto('BIO_ctrl_pending');
    @BIO_ctrl_wpending:= LoadFuncCLibCrypto('BIO_ctrl_wpending');
    @BIO_debug_callback:= LoadFuncCLibCrypto('BIO_debug_callback');
    @BIO_dgram_non_fatal_error:= LoadFuncCLibCrypto('BIO_dgram_non_fatal_error');
    @BIO_dump:= LoadFuncCLibCrypto('BIO_dump');
    @BIO_dump_cb:= LoadFuncCLibCrypto('BIO_dump_cb');
    @BIO_dump_fp:= LoadFuncCLibCrypto('BIO_dump_fp');
    @BIO_dump_indent:= LoadFuncCLibCrypto('BIO_dump_indent');
    @BIO_dump_indent_cb:= LoadFuncCLibCrypto('BIO_dump_indent_cb');
    @BIO_dump_indent_fp:= LoadFuncCLibCrypto('BIO_dump_indent_fp');
    @BIO_f_asn1:= LoadFuncCLibCrypto('BIO_f_asn1', false);
    ...
    @BIO_fd_non_fatal_error:= LoadFuncCLibCrypto('BIO_fd_non_fatal_error');
    @BIO_fd_should_retry:= LoadFuncCLibCrypto('BIO_fd_should_retry');
    @BIO_get_callback:= LoadFuncCLibCrypto('BIO_get_callback');
    @BIO_get_callback_arg:= LoadFuncCLibCrypto('BIO_get_callback_arg');
    @BIO_get_ex_data:= LoadFuncCLibCrypto('BIO_get_ex_data');
    @BIO_get_ex_new_index:= LoadFuncCLibCrypto('BIO_get_ex_new_index');
    @BIO_gethostbyname:= LoadFuncCLibCrypto('BIO_gethostbyname');
    @BIO_method_name:= LoadFuncCLibCrypto('BIO_method_name');
    @BIO_method_type:= LoadFuncCLibCrypto('BIO_method_type');
    @BIO_new_NDEF:= LoadFuncCLibCrypto('BIO_new_NDEF', False);
    @BIO_new_PKCS7:= LoadFuncCLibCrypto('BIO_new_PKCS7', false);
    @BIO_new_accept:= LoadFuncCLibCrypto('BIO_new_accept');
    @BIO_new_bio_pair:= LoadFuncCLibCrypto('BIO_new_bio_pair');
    @BIO_new_connect:= LoadFuncCLibCrypto('BIO_new_connect');
    @BIO_new_fd:= LoadFuncCLibCrypto('BIO_new_fd');
    @BIO_new_file:= LoadFuncCLibCrypto('BIO_new_file');
    @BIO_new_fp:= LoadFuncCLibCrypto('BIO_new_fp');
    @BIO_nread0:= LoadFuncCLibCrypto('BIO_nread0');
    @BIO_nread:= LoadFuncCLibCrypto('BIO_nread');
    @BIO_number_read:= LoadFuncCLibCrypto('BIO_number_read');
    @BIO_number_written:= LoadFuncCLibCrypto('BIO_number_written');
    @BIO_nwrite0:= LoadFuncCLibCrypto('BIO_nwrite0');
    @BIO_nwrite:= LoadFuncCLibCrypto('BIO_nwrite');
    @BIO_set_callback:= LoadFuncCLibCrypto('BIO_set_callback');
    @BIO_set_callback_arg:= LoadFuncCLibCrypto('BIO_set_callback_arg');
    @BIO_set_cipher:= LoadFuncCLibCrypto('BIO_set_cipher');
    @BIO_set_ex_data:= LoadFuncCLibCrypto('BIO_set_ex_data');
    @BIO_sock_non_fatal_error:= LoadFuncCLibCrypto('BIO_sock_non_fatal_error');
    @BIO_sock_should_retry:= LoadFuncCLibCrypto('BIO_sock_should_retry');
  end;
end;
