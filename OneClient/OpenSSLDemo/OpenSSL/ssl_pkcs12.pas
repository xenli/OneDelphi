...
begin
	if @PKCS12_new = nil then
		begin
			@PKCS12_x5092certbag:= LoadFuncCLibCrypto('PKCS12_x5092certbag');
			@PKCS12_x509crl2certbag:= LoadFuncCLibCrypto('PKCS12_x509crl2certbag');
			@PKCS12_certbag2x509:= LoadFuncCLibCrypto('PKCS12_certbag2x509');
			@PKCS12_certbag2x509crl:= LoadFuncCLibCrypto('PKCS12_certbag2x509crl');
			@PKCS12_item_pack_safebag:= LoadFuncCLibCrypto('PKCS12_item_pack_safebag');
			@PKCS12_MAKE_KEYBAG:= LoadFuncCLibCrypto('PKCS12_MAKE_KEYBAG');
			@PKCS8_decrypt:= LoadFuncCLibCrypto('PKCS8_decrypt');
			@PKCS12_decrypt_skey:= LoadFuncCLibCrypto('PKCS12_decrypt_skey');
			@PKCS8_encrypt:= LoadFuncCLibCrypto('PKCS8_encrypt');
			@PKCS12_MAKE_SHKEYBAG:= LoadFuncCLibCrypto('PKCS12_MAKE_SHKEYBAG');
			@PKCS12_pack_p7data:= LoadFuncCLibCrypto('PKCS12_pack_p7data');
			@PKCS12_unpack_p7data:= LoadFuncCLibCrypto('PKCS12_unpack_p7data');
			@PKCS12_pack_p7encdata:= LoadFuncCLibCrypto('PKCS12_pack_p7encdata');
			@PKCS12_unpack_p7encdata:= LoadFuncCLibCrypto('PKCS12_unpack_p7encdata');
			@PKCS12_pack_authsafes:= LoadFuncCLibCrypto('PKCS12_pack_authsafes');
			@PKCS12_unpack_authsafes:= LoadFuncCLibCrypto('PKCS12_unpack_authsafes');
			@PKCS12_add_localkeyid:= LoadFuncCLibCrypto('PKCS12_add_localkeyid');
			@PKCS12_add_friendlyname_asc:= LoadFuncCLibCrypto('PKCS12_add_friendlyname_asc');
			@PKCS12_add_CSPName_asc:= LoadFuncCLibCrypto('PKCS12_add_CSPName_asc');
			@PKCS12_add_friendlyname_uni:= LoadFuncCLibCrypto('PKCS12_add_friendlyname_uni');
			@PKCS8_add_keyusage:= LoadFuncCLibCrypto('PKCS8_add_keyusage');
			@PKCS12_get_attr_gen:= LoadFuncCLibCrypto('PKCS12_get_attr_gen');
			@PKCS12_get_friendlyname:= LoadFuncCLibCrypto('PKCS12_get_friendlyname');
			@PKCS12_pbe_crypt:= LoadFuncCLibCrypto('PKCS12_pbe_crypt');
			@PKCS12_item_decrypt_d2i:= LoadFuncCLibCrypto('PKCS12_item_decrypt_d2i');
			@PKCS12_item_i2d_encrypt:= LoadFuncCLibCrypto('PKCS12_item_i2d_encrypt');
			@PKCS12_init:= LoadFuncCLibCrypto('PKCS12_init');
			@PKCS12_key_gen_asc:= LoadFuncCLibCrypto('PKCS12_key_gen_asc');
			@PKCS12_key_gen_uni:= LoadFuncCLibCrypto('PKCS12_key_gen_uni');
			@PKCS12_PBE_keyivgen:= LoadFuncCLibCrypto('PKCS12_PBE_keyivgen');
			@PKCS12_gen_mac:= LoadFuncCLibCrypto('PKCS12_gen_mac');
			@PKCS12_verify_mac:= LoadFuncCLibCrypto('PKCS12_verify_mac');
			@PKCS12_set_mac:= LoadFuncCLibCrypto('PKCS12_set_mac');
			@PKCS12_setup_mac:= LoadFuncCLibCrypto('PKCS12_setup_mac');
			@OPENSSL_asc2uni:= LoadFuncCLibCrypto('OPENSSL_asc2uni');
			@OPENSSL_uni2asc:= LoadFuncCLibCrypto('OPENSSL_uni2asc');
			@PKCS12_new:= LoadFuncCLibCrypto('PKCS12_new');
			@PKCS12_free:= LoadFuncCLibCrypto('PKCS12_free');
			@d2i_PKCS12:= LoadFuncCLibCrypto('d2i_PKCS12');
			@i2d_PKCS12:= LoadFuncCLibCrypto('i2d_PKCS12');
			@PKCS12_it:= LoadFuncCLibCrypto('PKCS12_it');
			@PKCS12_MAC_DATA_new:= LoadFuncCLibCrypto('PKCS12_MAC_DATA_new');
			@PKCS12_MAC_DATA_free:= LoadFuncCLibCrypto('PKCS12_MAC_DATA_free');
			@d2i_PKCS12_MAC_DATA:= LoadFuncCLibCrypto('d2i_PKCS12_MAC_DATA');
			@i2d_PKCS12_MAC_DATA:= LoadFuncCLibCrypto('i2d_PKCS12_MAC_DATA');
			@PKCS12_MAC_DATA_it:= LoadFuncCLibCrypto('PKCS12_MAC_DATA_it');
			@PKCS12_SAFEBAG_new:= LoadFuncCLibCrypto('PKCS12_SAFEBAG_new');
			@PKCS12_SAFEBAG_free:= LoadFuncCLibCrypto('PKCS12_SAFEBAG_free');
			@d2i_PKCS12_SAFEBAG:= LoadFuncCLibCrypto('d2i_PKCS12_SAFEBAG');
			@i2d_PKCS12_SAFEBAG:= LoadFuncCLibCrypto('i2d_PKCS12_SAFEBAG');
			@PKCS12_SAFEBAG_it:= LoadFuncCLibCrypto('PKCS12_SAFEBAG_it');
			@PKCS12_BAGS_new:= LoadFuncCLibCrypto('PKCS12_BAGS_new');
			@PKCS12_BAGS_free:= LoadFuncCLibCrypto('PKCS12_BAGS_free');
			@d2i_PKCS12_BAGS:= LoadFuncCLibCrypto('d2i_PKCS12_BAGS');
			@i2d_PKCS12_BAGS:= LoadFuncCLibCrypto('i2d_PKCS12_BAGS');
			@PKCS12_BAGS_it:= LoadFuncCLibCrypto('PKCS12_BAGS_it');
			@PKCS12_PBE_add:= LoadFuncCLibCrypto('PKCS12_PBE_add');
			@PKCS12_parse:= LoadFuncCLibCrypto('PKCS12_parse');
			@PKCS12_create:= LoadFuncCLibCrypto('PKCS12_create');
			@PKCS12_add_cert:= LoadFuncCLibCrypto('PKCS12_add_cert');
			@PKCS12_add_key:= LoadFuncCLibCrypto('PKCS12_add_key');
			@PKCS12_add_safe:= LoadFuncCLibCrypto('PKCS12_add_safe');
			@PKCS12_add_safes:= LoadFuncCLibCrypto('PKCS12_add_safes');
			@i2d_PKCS12_bio:= LoadFuncCLibCrypto('i2d_PKCS12_bio');
			@d2i_PKCS12_bio:= LoadFuncCLibCrypto('d2i_PKCS12_bio');
			@PKCS12_newpass:= LoadFuncCLibCrypto('PKCS12_newpass');
			@ERR_load_PKCS12_strings:= LoadFuncCLibCrypto('ERR_load_PKCS12_strings');
